...
import type IUserIdentifier from "../interfaces/IUserIdentifier";
import type Plugin from "./Plugin";
import type PluginDelegate from "./PluginDelegate";
...
export default class Session implements ISession {
	...
	public getPluginProfileData<TProfileData>(
		plugin: Plugin,
		data: TProfileData,
	): TProfileData {
