...
import type { IReplayRegistryApiTypes } from "@ulixee/platform-specification/services/ReplayRegistryApis";
...
export default class ReplayRegistryDiskStore {
	...
	public async ids(): Promise<
		IReplayRegistryApiTypes["ReplayRegistry.ids"]["result"]
	> {
