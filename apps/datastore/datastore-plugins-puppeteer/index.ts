...
import {
	...
	type IExtractorPlugin,
	type IExtractorRunOptions,
	type IExtractorSchema,
...
export type IPuppeteerExtractorContext<ISchema> = IExtractorContext<ISchema> &
	IContextAddons;

export type IPuppeteerExtractorRunOptions<ISchema> =
	IExtractorRunOptions<ISchema> & IPuppeteerLaunchOptions;
