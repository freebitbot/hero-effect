...
export default {
	...
	channelHoldExpirationTicks: parseEnvInt(
		env.ARGON_CHANNEL_HOLD_EXPIRATION_TICKS,
	),
	ntpPoolUrl: env.ARGON_NTP_SERVER,
	allowMinimumAffordableChannelHold: parseEnvBool(
		env.ALLOW_MIN_AFFORDABLE_CHANNEL_HOLD,
	),
};
