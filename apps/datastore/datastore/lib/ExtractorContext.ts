...
import type ICrawlerOutputSchema from "../interfaces/ICrawlerOutputSchema";
...
import type ResultIterable from "./ResultIterable";
import type Table from "./Table";

export default class ExtractorContext<
	ISchema extends IExtractorSchema,
	TExtractorInternal extends
		ExtractorInternal<ISchema> = ExtractorInternal<ISchema>,
> implements IExtractorContext<ISchema>
{
	...
	public query<TResult>(
		...
		return this.#datastoreInternal.queryInternal(
			sql,
			boundValues,
			options,
			this.#callbacks,
