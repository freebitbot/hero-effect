...
import type { IViewportSize } from "@ulixee/unblocked-specification/agent/interact/IInteractionsHelper";
...
export function isRectInViewport(
	...
	const width = isRectPointInBoundary(
		rect.x,
		rect.width,
		viewport.width,
		multiplier,
	);
	const height = isRectPointInBoundary(
		rect.y,
		rect.height,
		viewport.height,
		multiplier,
