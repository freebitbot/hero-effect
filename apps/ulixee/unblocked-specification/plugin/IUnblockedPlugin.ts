import type { IFrame } from "../agent/browser/IFrame";
import type { IHooksProvider } from "../agent/hooks/IHooks";
import type IEmulationProfile from "./IEmulationProfile";
...
export type UnblockedPluginConfig<C extends object = any> =
	| PluginIsEnabledOrDisabled
	| PluginCustomConfig<C>;
...
export function UnblockedPluginClassDecorator(
	staticClass: IUnblockedPluginClass,
): void {}
