...
import type { IKeyboardKeyCode } from "./IKeyboardLayoutUS";
import type { IKeyboardShortcut } from "./IKeyboardShortcuts";
import type IMouseResult from "./IMouseResult";

export type IElementInteractVerification =
	| "elementAtPath"
	| "exactElement"
	| "none";
