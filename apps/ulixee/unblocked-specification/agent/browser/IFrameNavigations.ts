...
import type { NavigationStatus } from "./INavigation";
import type { LoadStatus } from "./Location";

export interface IFrameNavigations
	extends ITypedEventEmitter<IFrameNavigationEvents> {
	top: INavigation;
	...
	getPaintStableStatus(): { isStable: boolean; timeUntilReadyMs?: number };
}

export interface IFrameNavigationEvents {
	change: { navigation: INavigation };
