...
import type { IEventSubscriber } from "../interfaces/IRegisteredEventListener";
...
export default class EventSubscriber implements IEventSubscriber {
	...
	private readonly registeredEventListeners = new Set<
		IRegisteredEventListener & { id: number }
	>();
