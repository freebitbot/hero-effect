...
import type ITypedEventEmitter from "../interfaces/ITypedEventEmitter";
	...
	implements ITypedEventEmitter<T>
{
	...
	public cancelPendingEvents(
		message?: string,
		excludeEvents?: (keyof T & string)[],
	): void {
	...
	private logEvent<K extends keyof T & (string | symbol)>(
		eventType: K,
		event?: T[K],
	): void {
