...
import {
	HTMLMediaElementGenerator,
	type IHTMLMediaElementProperties,
} from "../../base/official-klasses/HTMLMediaElement";
...
export default class HTMLMediaElement
	extends HTMLMediaElementBaseClass
	implements IHTMLMediaElement
{
	constructor() {
		super();
	}
