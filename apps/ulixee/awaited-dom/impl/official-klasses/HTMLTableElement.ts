...
import {
	HTMLTableElementGenerator,
	type IHTMLTableElementProperties,
} from "../../base/official-klasses/HTMLTableElement";
...
export default class HTMLTableElement
	extends HTMLTableElementBaseClass
	implements IHTMLTableElement
{
	constructor() {
		super();
	}
