import type { ISuperText } from "../../base/interfaces/super";
import StateMachine from "../../base/StateMachine";
import {
	type ISuperTextProperties,
	SuperTextGenerator,
} from "../../base/super-klasses/SuperText";
...
>();
const SuperTextBaseClass = SuperTextGenerator(
...
export default class SuperText
	extends SuperTextBaseClass
	implements ISuperText
{
