...
import {
	type ISuperElementProperties,
	SuperElementGenerator,
} from "../../base/super-klasses/SuperElement";
import {
	createDOMTokenList,
	createNamedNodeMap,
	createShadowRoot,
...
>();
const SuperElementBaseClass = SuperElementGenerator(
...
export default class SuperElement
	extends SuperElementBaseClass
	implements ISuperElement
{
	constructor() {
		super();
	}
