...
import {
	type ISuperHTMLCollectionProperties,
	SuperHTMLCollectionGenerator,
} from "../../base/super-klasses/SuperHTMLCollection";
...
>();
const SuperHTMLCollectionBaseClass = SuperHTMLCollectionGenerator(
	HTMLCollectionBaseIsolate,
	HTMLCollectionIsolate,
	HTMLOptionsCollectionIsolate,
);

export default class SuperHTMLCollection
	extends SuperHTMLCollectionBaseClass
	implements ISuperHTMLCollection
{
	constructor() {
		super();
	}
