...
import {
	type ISuperDocumentProperties,
	SuperDocumentGenerator,
} from "../../base/super-klasses/SuperDocument";
import {
...
>();
const SuperDocumentBaseClass = SuperDocumentGenerator(
	DocumentIsolate,
...
export default class SuperDocument
	extends SuperDocumentBaseClass
	implements ISuperDocument
{
	constructor() {
		super();
	}
	...
	public get anchors(): ISuperHTMLCollection {
		...
		return createSuperHTMLCollection(
			awaitedPath.addProperty(this, "anchors"),
			awaitedOptions,
		);
	}
	...
	public get body(): ISuperHTMLElement {
		...
		return createSuperHTMLElement(
			awaitedPath.addProperty(this, "body"),
			awaitedOptions,
		);
	}
	...
	public get doctype(): IDocumentType {
		...
		return createDocumentType(
			awaitedPath.addProperty(this, "doctype"),
			awaitedOptions,
		);
	}
	...
	public get documentElement(): ISuperElement {
		...
		return createSuperElement(
			awaitedPath.addProperty(this, "documentElement"),
			awaitedOptions,
		);
	}
	...
	public get embeds(): ISuperHTMLCollection {
		const { awaitedPath, awaitedOptions } = getState(this);
		return createSuperHTMLCollection(
			awaitedPath.addProperty(this, "embeds"),
			awaitedOptions,
		);
	}
	...
	public get forms(): ISuperHTMLCollection {
		const { awaitedPath, awaitedOptions } = getState(this);
		return createSuperHTMLCollection(
			awaitedPath.addProperty(this, "forms"),
			awaitedOptions,
		);
	}
	...
	public get head(): IHTMLHeadElement {
		const { awaitedPath, awaitedOptions } = getState(this);
		return createHTMLHeadElement(
			awaitedPath.addProperty(this, "head"),
			awaitedOptions,
		);
	}
	...
	public get images(): ISuperHTMLCollection {
		const { awaitedPath, awaitedOptions } = getState(this);
		return createSuperHTMLCollection(
			awaitedPath.addProperty(this, "images"),
			awaitedOptions,
		);
	}
	...
	public get implementation(): IDOMImplementation {
		...
		return createDOMImplementation(
			awaitedPath.addProperty(this, "implementation"),
			awaitedOptions,
		);
	}
	...
	public get links(): ISuperHTMLCollection {
		const { awaitedPath, awaitedOptions } = getState(this);
		return createSuperHTMLCollection(
			awaitedPath.addProperty(this, "links"),
			awaitedOptions,
		);
	}
	...
	public get location(): ILocation {
		...
		return createLocation(
			awaitedPath.addProperty(this, "location"),
			awaitedOptions,
		);
	}
	...
	public get plugins(): ISuperHTMLCollection {
		const { awaitedPath, awaitedOptions } = getState(this);
		return createSuperHTMLCollection(
			awaitedPath.addProperty(this, "plugins"),
			awaitedOptions,
		);
	}
	...
	public get scripts(): ISuperHTMLCollection {
		const { awaitedPath, awaitedOptions } = getState(this);
		return createSuperHTMLCollection(
			awaitedPath.addProperty(this, "scripts"),
			awaitedOptions,
		);
	}
	...
	public get scrollingElement(): ISuperElement {
		const { awaitedPath, awaitedOptions } = getState(this);
		return createSuperElement(
			awaitedPath.addProperty(this, "scrollingElement"),
			awaitedOptions,
		);
	}
	...
	public getElementsByName(elementName: string): ISuperNodeList {
		...
		return createSuperNodeList(
			awaitedPath.addMethod(this, "getElementsByName", elementName),
			awaitedOptions,
		);
	}
