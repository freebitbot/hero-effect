import type AwaitedPath from "../base/AwaitedPath";
import type {
	IAbstractRange,
	IAttr,
	IAudioTrack,
...
export function createAbstractRange<IAwaitedOptions = {}>(
...
export function createAttr<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IAttr {
...
export function createAudioTrack<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IAudioTrack {
...
export function createAudioTrackList<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IAudioTrackList {
...
export function createBlob<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IBlob {
...
export function createCSSRule<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): ICSSRule {
...
export function createCSSRuleList<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): ICSSRuleList {
...
export function createCSSStyleDeclaration<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): ICSSStyleDeclaration {
	const CSSStyleDeclaration =
		require("./official-klasses/CSSStyleDeclaration").default; // tslint:disable-line:variable-name
	const instance = new CSSStyleDeclaration();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createCSSStyleSheet<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): ICSSStyleSheet {
...
export function createCaretPosition<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): ICaretPosition {
...
export function createCharacterData<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): ICharacterData {
...
export function createDOMImplementation<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IDOMImplementation {
	const DOMImplementation =
		require("./official-klasses/DOMImplementation").default; // tslint:disable-line:variable-name
	const instance = new DOMImplementation();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createDOMParser<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IDOMParser {
...
export function createDOMRect<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IDOMRect {
...
export function createDOMRectList<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IDOMRectList {
...
export function createDOMRectReadOnly<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IDOMRectReadOnly {
...
export function createDOMTokenList<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IDOMTokenList {
...
export function createDocument<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IDocument {
...
export function createDocumentFragment<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IDocumentFragment {
	const DocumentFragment =
		require("./official-klasses/DocumentFragment").default; // tslint:disable-line:variable-name
	const instance = new DocumentFragment();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createDocumentType<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IDocumentType {
...
export function createElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IElement {
...
export function createFeaturePolicy<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IFeaturePolicy {
...
export function createFile<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IFile {
...
export function createFileList<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IFileList {
...
export function createHTMLAnchorElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLAnchorElement {
	const HTMLAnchorElement =
		require("./official-klasses/HTMLAnchorElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLAnchorElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLAreaElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLAreaElement {
...
export function createHTMLAudioElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLAudioElement {
	const HTMLAudioElement =
		require("./official-klasses/HTMLAudioElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLAudioElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLBRElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLBRElement {
...
export function createHTMLBaseElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLBaseElement {
...
export function createHTMLBodyElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLBodyElement {
...
export function createHTMLButtonElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLButtonElement {
	const HTMLButtonElement =
		require("./official-klasses/HTMLButtonElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLButtonElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLCanvasElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLCanvasElement {
	const HTMLCanvasElement =
		require("./official-klasses/HTMLCanvasElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLCanvasElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLCollection<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLCollection {
...
export function createHTMLCollectionBase<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLCollectionBase {
	const HTMLCollectionBase =
		require("./official-klasses/HTMLCollectionBase").default; // tslint:disable-line:variable-name
	const instance = new HTMLCollectionBase();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLDListElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLDListElement {
	const HTMLDListElement =
		require("./official-klasses/HTMLDListElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLDListElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLDataElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLDataElement {
...
export function createHTMLDataListElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLDataListElement {
	const HTMLDataListElement =
		require("./official-klasses/HTMLDataListElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLDataListElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLDetailsElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLDetailsElement {
	const HTMLDetailsElement =
		require("./official-klasses/HTMLDetailsElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLDetailsElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLDialogElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLDialogElement {
	const HTMLDialogElement =
		require("./official-klasses/HTMLDialogElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLDialogElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLDirectoryElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLDirectoryElement {
	const HTMLDirectoryElement =
		require("./official-klasses/HTMLDirectoryElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLDirectoryElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLDivElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLDivElement {
...
export function createHTMLDocument<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLDocument {
...
export function createHTMLElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLElement {
...
export function createHTMLEmbedElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLEmbedElement {
	const HTMLEmbedElement =
		require("./official-klasses/HTMLEmbedElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLEmbedElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLFieldSetElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLFieldSetElement {
	const HTMLFieldSetElement =
		require("./official-klasses/HTMLFieldSetElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLFieldSetElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLFontElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLFontElement {
...
export function createHTMLFormControlsCollection<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLFormControlsCollection {
	const HTMLFormControlsCollection =
		require("./official-klasses/HTMLFormControlsCollection").default; // tslint:disable-line:variable-name
	const instance = new HTMLFormControlsCollection();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLFormElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLFormElement {
...
export function createHTMLFrameElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLFrameElement {
	const HTMLFrameElement =
		require("./official-klasses/HTMLFrameElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLFrameElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLFrameSetElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLFrameSetElement {
	const HTMLFrameSetElement =
		require("./official-klasses/HTMLFrameSetElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLFrameSetElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLHRElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLHRElement {
...
export function createHTMLHeadElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLHeadElement {
...
export function createHTMLHeadingElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLHeadingElement {
	const HTMLHeadingElement =
		require("./official-klasses/HTMLHeadingElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLHeadingElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLHtmlElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLHtmlElement {
...
export function createHTMLIFrameElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLIFrameElement {
	const HTMLIFrameElement =
		require("./official-klasses/HTMLIFrameElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLIFrameElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLImageElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLImageElement {
	const HTMLImageElement =
		require("./official-klasses/HTMLImageElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLImageElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLInputElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLInputElement {
	const HTMLInputElement =
		require("./official-klasses/HTMLInputElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLInputElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLLIElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLLIElement {
...
export function createHTMLLabelElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLLabelElement {
	const HTMLLabelElement =
		require("./official-klasses/HTMLLabelElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLLabelElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLLegendElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLLegendElement {
	const HTMLLegendElement =
		require("./official-klasses/HTMLLegendElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLLegendElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLLinkElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLLinkElement {
...
export function createHTMLMapElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLMapElement {
...
export function createHTMLMediaElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLMediaElement {
	const HTMLMediaElement =
		require("./official-klasses/HTMLMediaElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLMediaElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLMetaElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLMetaElement {
...
export function createHTMLMeterElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLMeterElement {
	const HTMLMeterElement =
		require("./official-klasses/HTMLMeterElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLMeterElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLModElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLModElement {
...
export function createHTMLOListElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLOListElement {
	const HTMLOListElement =
		require("./official-klasses/HTMLOListElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLOListElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLObjectElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLObjectElement {
	const HTMLObjectElement =
		require("./official-klasses/HTMLObjectElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLObjectElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLOptGroupElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLOptGroupElement {
	const HTMLOptGroupElement =
		require("./official-klasses/HTMLOptGroupElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLOptGroupElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLOptionElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLOptionElement {
	const HTMLOptionElement =
		require("./official-klasses/HTMLOptionElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLOptionElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLOptionsCollection<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLOptionsCollection {
	const HTMLOptionsCollection =
		require("./official-klasses/HTMLOptionsCollection").default; // tslint:disable-line:variable-name
	const instance = new HTMLOptionsCollection();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLParagraphElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLParagraphElement {
	const HTMLParagraphElement =
		require("./official-klasses/HTMLParagraphElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLParagraphElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLParamElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLParamElement {
	const HTMLParamElement =
		require("./official-klasses/HTMLParamElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLParamElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLPreElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLPreElement {
...
export function createHTMLProgressElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLProgressElement {
	const HTMLProgressElement =
		require("./official-klasses/HTMLProgressElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLProgressElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLQuoteElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLQuoteElement {
	const HTMLQuoteElement =
		require("./official-klasses/HTMLQuoteElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLQuoteElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLScriptElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLScriptElement {
	const HTMLScriptElement =
		require("./official-klasses/HTMLScriptElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLScriptElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLSelectElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLSelectElement {
	const HTMLSelectElement =
		require("./official-klasses/HTMLSelectElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLSelectElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLSlotElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLSlotElement {
...
export function createHTMLSourceElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLSourceElement {
	const HTMLSourceElement =
		require("./official-klasses/HTMLSourceElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLSourceElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLSpanElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLSpanElement {
...
export function createHTMLStyleElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLStyleElement {
	const HTMLStyleElement =
		require("./official-klasses/HTMLStyleElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLStyleElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLTableCaptionElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLTableCaptionElement {
	const HTMLTableCaptionElement =
		require("./official-klasses/HTMLTableCaptionElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLTableCaptionElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLTableCellElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLTableCellElement {
	const HTMLTableCellElement =
		require("./official-klasses/HTMLTableCellElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLTableCellElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLTableColElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLTableColElement {
	const HTMLTableColElement =
		require("./official-klasses/HTMLTableColElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLTableColElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLTableElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLTableElement {
	const HTMLTableElement =
		require("./official-klasses/HTMLTableElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLTableElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLTableRowElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLTableRowElement {
	const HTMLTableRowElement =
		require("./official-klasses/HTMLTableRowElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLTableRowElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLTableSectionElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLTableSectionElement {
	const HTMLTableSectionElement =
		require("./official-klasses/HTMLTableSectionElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLTableSectionElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLTemplateElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLTemplateElement {
	const HTMLTemplateElement =
		require("./official-klasses/HTMLTemplateElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLTemplateElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLTextAreaElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLTextAreaElement {
	const HTMLTextAreaElement =
		require("./official-klasses/HTMLTextAreaElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLTextAreaElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLTimeElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLTimeElement {
...
export function createHTMLTitleElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLTitleElement {
	const HTMLTitleElement =
		require("./official-klasses/HTMLTitleElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLTitleElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLTrackElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLTrackElement {
	const HTMLTrackElement =
		require("./official-klasses/HTMLTrackElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLTrackElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLUListElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLUListElement {
	const HTMLUListElement =
		require("./official-klasses/HTMLUListElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLUListElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHTMLVideoElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHTMLVideoElement {
	const HTMLVideoElement =
		require("./official-klasses/HTMLVideoElement").default; // tslint:disable-line:variable-name
	const instance = new HTMLVideoElement();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createHeaders<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IHeaders {
...
export function createImageBitmap<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IImageBitmap {
...
export function createLocation<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): ILocation {
...
export function createMediaError<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IMediaError {
...
export function createMediaKeys<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IMediaKeys {
...
export function createMediaList<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IMediaList {
...
export function createMediaStream<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IMediaStream {
...
export function createNamedNodeMap<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): INamedNodeMap {
...
export function createNode<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): INode {
...
export function createNodeList<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): INodeList {
...
export function createOffscreenCanvas<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IOffscreenCanvas {
...
export function createRadioNodeList<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IRadioNodeList {
...
export function createRange<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IRange {
...
export function createRequest<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IRequest {
...
export function createResponse<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IResponse {
...
export function createSelection<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): ISelection {
...
export function createShadowRoot<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IShadowRoot {
...
export function createStorage<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IStorage {
...
export function createStyleSheet<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IStyleSheet {
...
export function createText<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IText {
...
export function createTextTrack<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): ITextTrack {
...
export function createTextTrackCue<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): ITextTrackCue {
...
export function createTextTrackCueList<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): ITextTrackCueList {
	const TextTrackCueList =
		require("./official-klasses/TextTrackCueList").default; // tslint:disable-line:variable-name
	const instance = new TextTrackCueList();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createTextTrackList<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): ITextTrackList {
...
export function createTimeRanges<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): ITimeRanges {
...
export function createValidityState<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IValidityState {
...
export function createVideoPlaybackQuality<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IVideoPlaybackQuality {
	const VideoPlaybackQuality =
		require("./official-klasses/VideoPlaybackQuality").default; // tslint:disable-line:variable-name
	const instance = new VideoPlaybackQuality();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createVideoTrack<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IVideoTrack {
...
export function createVideoTrackList<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IVideoTrackList {
...
export function createXMLSerializer<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IXMLSerializer {
...
export function createXPathEvaluator<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IXPathEvaluator {
...
export function createXPathExpression<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IXPathExpression {
...
export function createXPathResult<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): IXPathResult {
...
export function createSuperDocument<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): ISuperDocument {
...
export function createSuperElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): ISuperElement {
...
export function createSuperNode<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): ISuperNode {
...
export function createSuperNodeList<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): ISuperNodeList {
...
export function createSuperHTMLCollection<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): ISuperHTMLCollection {
	const SuperHTMLCollection =
		require("./super-klasses/SuperHTMLCollection").default; // tslint:disable-line:variable-name
	const instance = new SuperHTMLCollection();
	setState(instance, { awaitedPath, awaitedOptions });
	return instance;
}

export function createSuperText<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): ISuperText {
...
export function createSuperHTMLElement<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): ISuperHTMLElement {
...
export function createSuperStyleSheet<IAwaitedOptions = {}>(
	awaitedPath: AwaitedPath,
	awaitedOptions: IAwaitedOptions,
): ISuperStyleSheet {
