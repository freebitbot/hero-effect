import type { IDocumentIsolate } from "../../base/interfaces/isolate";
import type {
	IDOMImplementation,
	IDocumentType,
	IFeaturePolicy,
...
import DocumentIsolateBase, {
	type IDocumentIsolateProperties,
} from "../../base/isolate-mixins/DocumentIsolate";
...
export default class DocumentIsolate
	extends DocumentIsolateBase
	implements IDocumentIsolate
{
