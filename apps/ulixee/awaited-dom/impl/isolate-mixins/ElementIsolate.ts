import type { IElementIsolate } from "../../base/interfaces/isolate";
import type {
	IDOMTokenList,
	INamedNodeMap,
	IShadowRoot,
...
import ElementIsolateBase, {
	type IElementIsolateProperties,
} from "../../base/isolate-mixins/ElementIsolate";
...
export default class ElementIsolate
	extends ElementIsolateBase
	implements IElementIsolate
{
