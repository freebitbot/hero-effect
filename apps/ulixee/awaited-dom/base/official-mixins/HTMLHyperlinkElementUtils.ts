...
import type { IHTMLHyperlinkElementUtils } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLHyperlinkElementUtils>(
...
export const HTMLHyperlinkElementUtilsPropertyKeys = [
	"hash",
	"host",
	"hostname",
	"href",
