...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLElement>(
	"HTMLElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLElementGenerator(
	Element: Constructable<IElement>,
	...
	const Parent = ClassMixer(Element, [
	...
	return class HTMLElement
		extends Parent
		implements IHTMLElement, PromiseLike<IHTMLElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IHTMLElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
...
export interface IHTMLElementProperties
	extends IElementProperties,
