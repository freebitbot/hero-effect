...
import type { ITimeRanges } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<ITimeRanges>(
	"TimeRanges",
	getState,
	setState,
);
	...
	return class TimeRanges implements ITimeRanges {
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				TimeRangesPropertyKeys,
				TimeRangesConstantKeys,
			);
		}
	};
}
