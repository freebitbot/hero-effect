...
import type { IMediaError } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IMediaError>(
	"MediaError",
	getState,
	setState,
);
	...
	return class MediaError implements IMediaError {
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				MediaErrorPropertyKeys,
				MediaErrorConstantKeys,
			);
		}
	};
}
...
export const MediaErrorConstantKeys = [
	"MEDIA_ERR_ABORTED",
	"MEDIA_ERR_DECODE",
	"MEDIA_ERR_NETWORK",
