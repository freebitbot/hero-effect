...
import type { IHTMLDialogElement, IHTMLElement } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLDialogElement>(
	"HTMLDialogElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLDialogElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLDialogElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLDialogElement
		extends HTMLElement
		implements IHTMLDialogElement, PromiseLike<IHTMLDialogElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IHTMLDialogElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLDialogElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLDialogElementPropertyKeys,
				HTMLDialogElementConstantKeys,
			);
		}
	};
}
...
export const HTMLDialogElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	"open",
	"returnValue",
];
