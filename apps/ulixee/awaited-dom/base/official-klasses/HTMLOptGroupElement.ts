...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLOptGroupElement>(
	"HTMLOptGroupElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLOptGroupElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLOptGroupElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLOptGroupElement
		extends HTMLElement
		implements IHTMLOptGroupElement, PromiseLike<IHTMLOptGroupElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IHTMLOptGroupElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLOptGroupElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLOptGroupElementPropertyKeys,
				HTMLOptGroupElementConstantKeys,
			);
		}
	};
}
...
export const HTMLOptGroupElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	"disabled",
	"label",
];
