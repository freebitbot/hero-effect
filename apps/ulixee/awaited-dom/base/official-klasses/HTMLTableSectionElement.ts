...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLTableSectionElement>(
	"HTMLTableSectionElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLTableSectionElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLTableSectionElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLTableSectionElement
		extends HTMLElement
		implements IHTMLTableSectionElement, PromiseLike<IHTMLTableSectionElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IHTMLTableSectionElement, TResult2 = never>(
			onfulfilled?:
				| ((
						value: IHTMLTableSectionElement,
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLTableSectionElementPropertyKeys,
				HTMLTableSectionElementConstantKeys,
			);
		}
	};
}
...
export interface IHTMLTableSectionElementProperties
...
export const HTMLTableSectionElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	"align",
	"ch",
	"chOff",
