...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLObjectElement>(
	"HTMLObjectElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLObjectElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLObjectElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLObjectElement
		extends HTMLElement
		implements IHTMLObjectElement, PromiseLike<IHTMLObjectElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public get contentDocument(): ISuperDocument {
			throw new Error(
				"HTMLObjectElement.contentDocument getter not implemented",
			);
		}
		...
		public then<TResult1 = IHTMLObjectElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLObjectElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLObjectElementPropertyKeys,
				HTMLObjectElementConstantKeys,
			);
		}
	};
}
...
export const HTMLObjectElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	"align",
	"archive",
	"border",
