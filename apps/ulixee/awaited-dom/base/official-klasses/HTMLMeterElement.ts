...
import type { IHTMLElement, IHTMLMeterElement } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLMeterElement>(
	"HTMLMeterElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLMeterElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLMeterElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLMeterElement
		extends HTMLElement
		implements IHTMLMeterElement, PromiseLike<IHTMLMeterElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IHTMLMeterElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLMeterElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLMeterElementPropertyKeys,
				HTMLMeterElementConstantKeys,
			);
		}
	};
}
...
export const HTMLMeterElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	"high",
	"labels",
	"low",
