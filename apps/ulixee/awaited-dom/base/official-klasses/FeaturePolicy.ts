...
import type { IFeaturePolicy } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IFeaturePolicy>(
	"FeaturePolicy",
	getState,
	setState,
);
	...
	return class FeaturePolicy implements IFeaturePolicy {
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				FeaturePolicyPropertyKeys,
				FeaturePolicyConstantKeys,
			);
		}
	};
}
