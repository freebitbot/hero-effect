...
import type { IGetRootNodeOptions, INode } from "../interfaces/official";
import type {
	ISuperDocument,
	ISuperElement,
	ISuperNode,
...
export const awaitedHandler = new AwaitedHandler<INode>(
	"Node",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<INode>(
	getState,
	setState,
	awaitedHandler,
);
...
export function NodeGenerator() {
	return class Node implements INode, PromiseLike<INode> {
		...
		public then<TResult1 = INode, TResult2 = never>(
			onfulfilled?:
				| ((value: INode) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
