...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLFrameSetElement>(
	"HTMLFrameSetElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLFrameSetElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLFrameSetElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLFrameSetElement
		extends HTMLElement
		implements IHTMLFrameSetElement, PromiseLike<IHTMLFrameSetElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IHTMLFrameSetElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLFrameSetElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLFrameSetElementPropertyKeys,
				HTMLFrameSetElementConstantKeys,
			);
		}
	};
}
...
export const HTMLFrameSetElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	"cols",
	"rows",
];
