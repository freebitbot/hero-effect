...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLFormControlsCollection>(
	"HTMLFormControlsCollection",
	getState,
	setState,
);

export function HTMLFormControlsCollectionGenerator(
	HTMLCollectionBase: Constructable<IHTMLCollectionBase>,
) {
	return class HTMLFormControlsCollection
		...
		implements IHTMLFormControlsCollection
	{
		...
		public namedItem(
			name: string,
		): Promise<IRadioNodeList | ISuperElement | null> {
			return awaitedHandler.runMethod<IRadioNodeList | ISuperElement | null>(
				this,
				"namedItem",
				[name],
			);
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLFormControlsCollectionPropertyKeys,
				HTMLFormControlsCollectionConstantKeys,
			);
		}
	};
}
...
export interface IHTMLFormControlsCollectionProperties
	extends IHTMLCollectionBaseProperties {
	awaitedPath: AwaitedPath;
	awaitedOptions: any;
}

export const HTMLFormControlsCollectionPropertyKeys = [
	...HTMLCollectionBasePropertyKeys,
];

export const HTMLFormControlsCollectionConstantKeys = [
	...HTMLCollectionBaseConstantKeys,
];
