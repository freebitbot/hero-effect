...
import type { IHTMLElement, IHTMLUListElement } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLUListElement>(
	"HTMLUListElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLUListElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLUListElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLUListElement
		extends HTMLElement
		implements IHTMLUListElement, PromiseLike<IHTMLUListElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IHTMLUListElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLUListElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLUListElementPropertyKeys,
				HTMLUListElementConstantKeys,
			);
		}
	};
}
...
export const HTMLUListElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	"compact",
	"type",
];
