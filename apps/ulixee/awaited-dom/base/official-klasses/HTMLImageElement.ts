...
import type { IHTMLElement, IHTMLImageElement } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLImageElement>(
	"HTMLImageElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLImageElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLImageElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLImageElement
		extends HTMLElement
		implements IHTMLImageElement, PromiseLike<IHTMLImageElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IHTMLImageElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLImageElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLImageElementPropertyKeys,
				HTMLImageElementConstantKeys,
			);
		}
	};
}
...
export const HTMLImageElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	"alt",
	"complete",
	"crossOrigin",
