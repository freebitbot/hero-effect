...
import type { IDOMRect, IDOMRectReadOnly } from "../interfaces/official";
import StateMachine from "../StateMachine";
import {
	DOMRectReadOnlyConstantKeys,
	DOMRectReadOnlyPropertyKeys,
...
export const { getState, setState } = StateMachine<
	...
	IDOMRectProperties
>();
export const awaitedHandler = new AwaitedHandler<IDOMRect>(
	"DOMRect",
	getState,
	setState,
);
...
export function DOMRectGenerator(
	DOMRectReadOnly: Constructable<IDOMRectReadOnly>,
) {
