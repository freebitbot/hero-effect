...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLTableElement>(
	"HTMLTableElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLTableElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLTableElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLTableElement
		extends HTMLElement
		implements IHTMLTableElement, PromiseLike<IHTMLTableElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IHTMLTableElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLTableElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLTableElementPropertyKeys,
				HTMLTableElementConstantKeys,
			);
		}
	};
}
...
export const HTMLTableElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	"align",
	"bgColor",
	"border",
