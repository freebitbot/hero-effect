...
>();
export const awaitedHandler = new AwaitedHandler<ICharacterData>(
	"CharacterData",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<ICharacterData>(
	getState,
	setState,
	awaitedHandler,
);

export function CharacterDataGenerator(
	Node: Constructable<INode>,
	NonDocumentTypeChildNode: Constructable<INonDocumentTypeChildNode>,
) {
	const Parent = ClassMixer(Node, [
		NonDocumentTypeChildNode,
	]) as unknown as Constructable<INode & INonDocumentTypeChildNode>;

	return class CharacterData
		extends Parent
		implements ICharacterData, PromiseLike<ICharacterData>
	{
		constructor() {
			super();
			setState(this, {
		...
		public substringData(offset: number, count: number): Promise<string> {
			return awaitedHandler.runMethod<string>(this, "substringData", [
				offset,
				count,
			]);
		}

		public then<TResult1 = ICharacterData, TResult2 = never>(
			onfulfilled?:
				| ((value: ICharacterData) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
...
export interface ICharacterDataProperties
	extends INodeProperties,
...
export const CharacterDataPropertyKeys = [
	...NodePropertyKeys,
	...NonDocumentTypeChildNodePropertyKeys,
	"data",
	"length",
...
export const CharacterDataConstantKeys = [
	...NodeConstantKeys,
	...NonDocumentTypeChildNodeConstantKeys,
];
