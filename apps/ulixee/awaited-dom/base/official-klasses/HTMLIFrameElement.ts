...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLIFrameElement>(
	"HTMLIFrameElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLIFrameElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLIFrameElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLIFrameElement
		extends HTMLElement
		implements IHTMLIFrameElement, PromiseLike<IHTMLIFrameElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public get contentDocument(): ISuperDocument {
			throw new Error(
				"HTMLIFrameElement.contentDocument getter not implemented",
			);
		}
		...
		public then<TResult1 = IHTMLIFrameElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLIFrameElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLIFrameElementPropertyKeys,
				HTMLIFrameElementConstantKeys,
			);
		}
	};
}
...
export const HTMLIFrameElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	"align",
	"allow",
	"allowFullscreen",
