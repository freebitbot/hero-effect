...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLFieldSetElement>(
	"HTMLFieldSetElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLFieldSetElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLFieldSetElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLFieldSetElement
		extends HTMLElement
		implements IHTMLFieldSetElement, PromiseLike<IHTMLFieldSetElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IHTMLFieldSetElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLFieldSetElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLFieldSetElementPropertyKeys,
				HTMLFieldSetElementConstantKeys,
			);
		}
	};
}
...
export const HTMLFieldSetElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	"disabled",
	"elements",
	"form",
