...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLMediaElement>(
	"HTMLMediaElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLMediaElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLMediaElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLMediaElement
		extends HTMLElement
		implements IHTMLMediaElement, PromiseLike<IHTMLMediaElement>
	{
		...
		public then<TResult1 = IHTMLMediaElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLMediaElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
...
export const HTMLMediaElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	"audioTracks",
	"autoplay",
	"buffered",
...
export const HTMLMediaElementConstantKeys = [
	...HTMLElementConstantKeys,
	"HAVE_CURRENT_DATA",
	"HAVE_ENOUGH_DATA",
	"HAVE_FUTURE_DATA",
