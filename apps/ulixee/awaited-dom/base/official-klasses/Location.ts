...
import type { ILocation } from "../interfaces/official";
...
export const { getState, setState } = StateMachine<
	...
	ILocationProperties
>();
export const awaitedHandler = new AwaitedHandler<ILocation>(
	"Location",
	getState,
	setState,
);
...
export const LocationPropertyKeys = [
	"hash",
	"host",
	"hostname",
	"href",
