...
import type { ISuperHTMLElement, ISuperNodeList } from "../interfaces/super";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLInputElement>(
	"HTMLInputElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLInputElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLInputElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLInputElement
		extends HTMLElement
		implements IHTMLInputElement, PromiseLike<IHTMLInputElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public get selectionEnd(): Promise<number | null> {
			return awaitedHandler.getProperty<number | null>(
				this,
				"selectionEnd",
				true,
			);
		...
		public get validationMessage(): Promise<string> {
			return awaitedHandler.getProperty<string>(
				this,
				"validationMessage",
				false,
			);
		...
		public get validity(): Promise<IValidityState> {
			return awaitedHandler.getProperty<IValidityState>(
				this,
				"validity",
				false,
			);
		...
		public setRangeText(
			...
			return awaitedHandler.runMethod<void>(this, "setRangeText", [
				replacement,
				start,
				end,
				selectionMode,
		...
		public setSelectionRange(
			...
			return awaitedHandler.runMethod<void>(this, "setSelectionRange", [
				start,
				end,
				direction,
			]);
		...
		public then<TResult1 = IHTMLInputElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLInputElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLInputElementPropertyKeys,
				HTMLInputElementConstantKeys,
			);
		}
	};
}
...
export const HTMLInputElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	"accept",
	"alt",
	"autocomplete",
