...
import type { IImageBitmap } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IImageBitmap>(
	"ImageBitmap",
	getState,
	setState,
);
	...
	return class ImageBitmap implements IImageBitmap {
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				ImageBitmapPropertyKeys,
				ImageBitmapConstantKeys,
			);
		}
	};
}
