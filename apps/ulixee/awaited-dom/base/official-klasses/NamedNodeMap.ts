...
import type { IAttr, INamedNodeMap } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<INamedNodeMap>(
	"NamedNodeMap",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<INamedNodeMap>(
	getState,
	setState,
	awaitedHandler,
);
export const awaitedIterator = new AwaitedIterator<INamedNodeMap, IAttr>(
	getState,
	setState,
	awaitedHandler,
);
...
export function NamedNodeMapGenerator() {
	return class NamedNodeMap
		implements INamedNodeMap, PromiseLike<INamedNodeMap>
	{
		constructor() {
			setState(this, {
		...
		public getNamedItem(qualifiedName: string): Promise<IAttr | null> {
			return awaitedHandler.runMethod<IAttr | null>(this, "getNamedItem", [
				qualifiedName,
			]);
		}
		...
		public getNamedItemNS(
			...
			return awaitedHandler.runMethod<IAttr | null>(this, "getNamedItemNS", [
				namespace,
				localName,
			]);
		}
		...
		public then<TResult1 = INamedNodeMap, TResult2 = never>(
			onfulfilled?:
				| ((value: INamedNodeMap) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				NamedNodeMapPropertyKeys,
				NamedNodeMapConstantKeys,
			);
		}
	};
}
