...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLTextAreaElement>(
	"HTMLTextAreaElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLTextAreaElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLTextAreaElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLTextAreaElement
		extends HTMLElement
		implements IHTMLTextAreaElement, PromiseLike<IHTMLTextAreaElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IHTMLTextAreaElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLTextAreaElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLTextAreaElementPropertyKeys,
				HTMLTextAreaElementConstantKeys,
			);
		}
	};
}
