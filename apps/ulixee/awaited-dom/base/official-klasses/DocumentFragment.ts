...
>();
export const awaitedHandler = new AwaitedHandler<IDocumentFragment>(
	"DocumentFragment",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IDocumentFragment>(
	getState,
	setState,
	awaitedHandler,
);

export function DocumentFragmentGenerator(
	...
	const Parent = ClassMixer(Node, [
		...
		ParentNode,
	]) as unknown as Constructable<INode & INonElementParentNode & IParentNode>;

	return class DocumentFragment
		extends Parent
		implements IDocumentFragment, PromiseLike<IDocumentFragment>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IDocumentFragment, TResult2 = never>(
			onfulfilled?:
				| ((value: IDocumentFragment) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
...
export interface IDocumentFragmentProperties
...
export const DocumentFragmentPropertyKeys = [
	...NodePropertyKeys,
	...NonElementParentNodePropertyKeys,
	...ParentNodePropertyKeys,
];

export const DocumentFragmentConstantKeys = [
	...NodeConstantKeys,
	...NonElementParentNodeConstantKeys,
	...ParentNodeConstantKeys,
];
