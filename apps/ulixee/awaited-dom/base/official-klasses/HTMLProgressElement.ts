...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLProgressElement>(
	"HTMLProgressElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLProgressElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLProgressElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLProgressElement
		extends HTMLElement
		implements IHTMLProgressElement, PromiseLike<IHTMLProgressElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IHTMLProgressElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLProgressElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLProgressElementPropertyKeys,
				HTMLProgressElementConstantKeys,
			);
		}
	};
}
...
export const HTMLProgressElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	"labels",
	"max",
	"position",
