...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLSelectElement>(
	"HTMLSelectElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLSelectElement>(
	getState,
	setState,
	awaitedHandler,
);
...
export function HTMLSelectElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLSelectElement
		extends HTMLElement
		implements IHTMLSelectElement, PromiseLike<IHTMLSelectElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public get selectedOptions(): ISuperHTMLCollection {
			throw new Error(
				"HTMLSelectElement.selectedOptions getter not implemented",
			);
		}
		...
		public then<TResult1 = IHTMLSelectElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLSelectElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLSelectElementPropertyKeys,
				HTMLSelectElementConstantKeys,
			);
		}
	};
}
...
export const HTMLSelectElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	"autocomplete",
	"autofocus",
	"disabled",
