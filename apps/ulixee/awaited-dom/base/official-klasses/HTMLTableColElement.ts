...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLTableColElement>(
	"HTMLTableColElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLTableColElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLTableColElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLTableColElement
		extends HTMLElement
		implements IHTMLTableColElement, PromiseLike<IHTMLTableColElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IHTMLTableColElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLTableColElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLTableColElementPropertyKeys,
				HTMLTableColElementConstantKeys,
			);
		}
	};
}
...
export const HTMLTableColElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	"align",
	"ch",
	"chOff",
