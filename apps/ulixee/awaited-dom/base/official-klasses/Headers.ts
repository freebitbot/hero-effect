...
import type { IHeaders, IHeadersInit } from "../interfaces/official";
...
export const { getState, setState } = StateMachine<
	...
	IHeadersProperties
>();
export const awaitedHandler = new AwaitedHandler<IHeaders>(
	"Headers",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHeaders>(
	getState,
	setState,
	awaitedHandler,
);
export const awaitedIterator = new AwaitedIterator<IHeaders, [string, string]>(
	getState,
	setState,
	awaitedHandler,
);
...
export function HeadersGenerator() {
	return class Headers implements IHeaders, PromiseLike<IHeaders> {
		...
		public then<TResult1 = IHeaders, TResult2 = never>(
			onfulfilled?:
				| ((value: IHeaders) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
