...
import type { IHTMLElement, IHTMLLIElement } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLLIElement>(
	"HTMLLIElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLLIElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLLIElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLLIElement
		extends HTMLElement
		implements IHTMLLIElement, PromiseLike<IHTMLLIElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IHTMLLIElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLLIElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLLIElementPropertyKeys,
				HTMLLIElementConstantKeys,
			);
		}
	};
}
...
export const HTMLLIElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	"type",
	"value",
];
