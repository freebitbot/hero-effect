...
export const { getState, setState } = StateMachine<
	...
	IElementProperties
>();
export const awaitedHandler = new AwaitedHandler<IElement>(
	"Element",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IElement>(
	getState,
	setState,
	awaitedHandler,
);
...
export function ElementGenerator(
	...
	const Parent = ClassMixer(Node, [
		...
		INode & INonDocumentTypeChildNode & IParentNode & ISlotable
	>;

	return class Element
		extends Parent
		implements IElement, PromiseLike<IElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
...
export const ElementPropertyKeys = [
	...NodePropertyKeys,
	...NonDocumentTypeChildNodePropertyKeys,
	...ParentNodePropertyKeys,
	...SlotablePropertyKeys,
...
export const ElementConstantKeys = [
	...NodeConstantKeys,
	...NonDocumentTypeChildNodeConstantKeys,
	...ParentNodeConstantKeys,
	...SlotableConstantKeys,
