...
import type { IHTMLElement, IHTMLFontElement } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLFontElement>(
	"HTMLFontElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLFontElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLFontElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLFontElement
		extends HTMLElement
		implements IHTMLFontElement, PromiseLike<IHTMLFontElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IHTMLFontElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLFontElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLFontElementPropertyKeys,
				HTMLFontElementConstantKeys,
			);
		}
	};
}
...
export const HTMLFontElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	"color",
	"face",
	"size",
