...
export const { getState, setState } = StateMachine<
	...
	IDocumentProperties
>();
export const awaitedHandler = new AwaitedHandler<IDocument>(
	"Document",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IDocument>(
	getState,
	setState,
	awaitedHandler,
);
...
export function DocumentGenerator(
	...
	return class Document
		extends Parent
		implements IDocument, PromiseLike<IDocument>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IDocument, TResult2 = never>(
			onfulfilled?:
				| ((value: IDocument) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
