...
import type { IHTMLElement, IHTMLOListElement } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLOListElement>(
	"HTMLOListElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLOListElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLOListElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLOListElement
		extends HTMLElement
		implements IHTMLOListElement, PromiseLike<IHTMLOListElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IHTMLOListElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLOListElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLOListElementPropertyKeys,
				HTMLOListElementConstantKeys,
			);
		}
	};
}
...
export const HTMLOListElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	"compact",
	"reversed",
	"start",
