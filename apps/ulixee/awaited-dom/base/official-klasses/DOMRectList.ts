...
import type { IDOMRect, IDOMRectList } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IDOMRectList>(
	"DOMRectList",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IDOMRectList>(
	getState,
	setState,
	awaitedHandler,
);
export const awaitedIterator = new AwaitedIterator<IDOMRectList, IDOMRect>(
	getState,
	setState,
	awaitedHandler,
);
...
export function DOMRectListGenerator() {
	return class DOMRectList implements IDOMRectList, PromiseLike<IDOMRectList> {
		...
		public then<TResult1 = IDOMRectList, TResult2 = never>(
			onfulfilled?:
				| ((value: IDOMRectList) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				DOMRectListPropertyKeys,
				DOMRectListConstantKeys,
			);
		}
	};
}
