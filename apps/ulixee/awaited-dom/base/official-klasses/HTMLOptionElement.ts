...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLOptionElement>(
	"HTMLOptionElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLOptionElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLOptionElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLOptionElement
		extends HTMLElement
		implements IHTMLOptionElement, PromiseLike<IHTMLOptionElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IHTMLOptionElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLOptionElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLOptionElementPropertyKeys,
				HTMLOptionElementConstantKeys,
			);
		}
	};
}
...
export const HTMLOptionElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	"defaultSelected",
	"disabled",
	"form",
