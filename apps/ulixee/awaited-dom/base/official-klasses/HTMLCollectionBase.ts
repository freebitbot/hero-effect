...
import type { IHTMLCollectionBase } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLCollectionBase>(
	"HTMLCollectionBase",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLCollectionBase>(
	getState,
	setState,
	awaitedHandler,
);
...
export function HTMLCollectionBaseGenerator() {
	return class HTMLCollectionBase
		implements IHTMLCollectionBase, PromiseLike<IHTMLCollectionBase>
	{
		constructor() {
			setState(this, {
		...
		public then<TResult1 = IHTMLCollectionBase, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLCollectionBase) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
