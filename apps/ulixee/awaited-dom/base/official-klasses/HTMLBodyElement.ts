...
import type { IHTMLBodyElement, IHTMLElement } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLBodyElement>(
	"HTMLBodyElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLBodyElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLBodyElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLBodyElement
		extends HTMLElement
		implements IHTMLBodyElement, PromiseLike<IHTMLBodyElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IHTMLBodyElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLBodyElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLBodyElementPropertyKeys,
				HTMLBodyElementConstantKeys,
			);
		}
	};
}
...
export const HTMLBodyElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	"aLink",
	"background",
	"bgColor",
