...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLLabelElement>(
	"HTMLLabelElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLLabelElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLLabelElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLLabelElement
		extends HTMLElement
		implements IHTMLLabelElement, PromiseLike<IHTMLLabelElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IHTMLLabelElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLLabelElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLLabelElementPropertyKeys,
				HTMLLabelElementConstantKeys,
			);
		}
	};
}
...
export const HTMLLabelElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	"control",
	"form",
	"htmlFor",
