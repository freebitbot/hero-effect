...
import type { IAudioTrack } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IAudioTrack>(
	"AudioTrack",
	getState,
	setState,
);
	...
	return class AudioTrack implements IAudioTrack {
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				AudioTrackPropertyKeys,
				AudioTrackConstantKeys,
			);
		}
	};
}
...
export const AudioTrackPropertyKeys = [
	"enabled",
	"id",
	"kind",
	"label",
