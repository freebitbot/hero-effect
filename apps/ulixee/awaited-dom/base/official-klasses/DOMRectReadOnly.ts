...
import type { IDOMRectReadOnly } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IDOMRectReadOnly>(
	"DOMRectReadOnly",
	getState,
	setState,
);
...
export const DOMRectReadOnlyPropertyKeys = [
	"bottom",
	"height",
	"left",
	"right",
