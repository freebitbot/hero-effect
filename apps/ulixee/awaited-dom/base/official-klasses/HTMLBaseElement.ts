...
import type { IHTMLBaseElement, IHTMLElement } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLBaseElement>(
	"HTMLBaseElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLBaseElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLBaseElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLBaseElement
		extends HTMLElement
		implements IHTMLBaseElement, PromiseLike<IHTMLBaseElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IHTMLBaseElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLBaseElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLBaseElementPropertyKeys,
				HTMLBaseElementConstantKeys,
			);
		}
	};
}
...
export const HTMLBaseElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	"href",
	"target",
];
