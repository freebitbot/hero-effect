...
import type { IVideoTrack } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IVideoTrack>(
	"VideoTrack",
	getState,
	setState,
);
	...
	return class VideoTrack implements IVideoTrack {
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				VideoTrackPropertyKeys,
				VideoTrackConstantKeys,
			);
		}
	};
}
...
export const VideoTrackPropertyKeys = [
	"id",
	"kind",
	"label",
	"language",
