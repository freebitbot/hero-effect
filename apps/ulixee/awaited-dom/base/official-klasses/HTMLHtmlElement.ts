...
import type { IHTMLElement, IHTMLHtmlElement } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLHtmlElement>(
	"HTMLHtmlElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLHtmlElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLHtmlElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLHtmlElement
		extends HTMLElement
		implements IHTMLHtmlElement, PromiseLike<IHTMLHtmlElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IHTMLHtmlElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLHtmlElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLHtmlElementPropertyKeys,
				HTMLHtmlElementConstantKeys,
			);
		}
	};
}
...
export const HTMLHtmlElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	"version",
];
