...
import type { IHTMLElement, IHTMLMetaElement } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLMetaElement>(
	"HTMLMetaElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLMetaElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLMetaElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLMetaElement
		extends HTMLElement
		implements IHTMLMetaElement, PromiseLike<IHTMLMetaElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IHTMLMetaElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLMetaElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLMetaElementPropertyKeys,
				HTMLMetaElementConstantKeys,
			);
		}
	};
}
...
export const HTMLMetaElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	"content",
	"httpEquiv",
	"name",
