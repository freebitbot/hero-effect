...
import type { IHTMLElement, IHTMLParamElement } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLParamElement>(
	"HTMLParamElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLParamElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLParamElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLParamElement
		extends HTMLElement
		implements IHTMLParamElement, PromiseLike<IHTMLParamElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IHTMLParamElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLParamElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLParamElementPropertyKeys,
				HTMLParamElementConstantKeys,
			);
		}
	};
}
...
export const HTMLParamElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	"name",
	"type",
	"value",
