...
import type { IRange, ISelection } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<ISelection>(
	"Selection",
	getState,
	setState,
);
...
export function SelectionGenerator() {
	return class Selection implements ISelection {
		...
		public containsNode(
			...
			return awaitedHandler.runMethod<boolean>(this, "containsNode", [
				node,
		...
		public modify(
			...
			return awaitedHandler.runMethod<void>(this, "modify", [
				alter,
				direction,
				granularity,
			]);
		...
		public setBaseAndExtent(
			...
			return awaitedHandler.runMethod<void>(this, "setBaseAndExtent", [
				anchorNode,
				anchorOffset,
				focusNode,
				focusOffset,
		...
		public setPosition(
			node: INodeIsolate | null,
			offset?: number,
		): Promise<void> {
			return awaitedHandler.runMethod<void>(this, "setPosition", [
				node,
				offset,
			]);
		}
