...
import type { INodeList, IRadioNodeList } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IRadioNodeList>(
	"RadioNodeList",
	getState,
	setState,
);
	...
	return class RadioNodeList extends NodeList implements IRadioNodeList {
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				RadioNodeListPropertyKeys,
				RadioNodeListConstantKeys,
			);
		}
	};
}
