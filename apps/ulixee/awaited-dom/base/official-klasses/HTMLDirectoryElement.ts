...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLDirectoryElement>(
	"HTMLDirectoryElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLDirectoryElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLDirectoryElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLDirectoryElement
		extends HTMLElement
		implements IHTMLDirectoryElement, PromiseLike<IHTMLDirectoryElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IHTMLDirectoryElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLDirectoryElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLDirectoryElementPropertyKeys,
				HTMLDirectoryElementConstantKeys,
			);
		}
	};
}
...
export interface IHTMLDirectoryElementProperties
...
export const HTMLDirectoryElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	"compact",
];
