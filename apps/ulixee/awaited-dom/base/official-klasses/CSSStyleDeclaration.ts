...
import type { ICSSRule, ICSSStyleDeclaration } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<ICSSStyleDeclaration>(
	"CSSStyleDeclaration",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<ICSSStyleDeclaration>(
	getState,
	setState,
	awaitedHandler,
);
...
export function CSSStyleDeclarationGenerator() {
	return class CSSStyleDeclaration
		implements ICSSStyleDeclaration, PromiseLike<ICSSStyleDeclaration>
	{
		constructor() {
			setState(this, {
		...
		public getPropertyPriority(property: string): Promise<string> {
			return awaitedHandler.runMethod<string>(this, "getPropertyPriority", [
				property,
			]);
		}

		public getPropertyValue(property: string): Promise<string> {
			return awaitedHandler.runMethod<string>(this, "getPropertyValue", [
				property,
			]);
		}
		...
		public removeProperty(property: string): Promise<string> {
			return awaitedHandler.runMethod<string>(this, "removeProperty", [
				property,
			]);
		}
		...
		public setProperty(
			...
			return awaitedHandler.runMethod<void>(this, "setProperty", [
				property,
				value,
				priority,
			]);
		...
		public then<TResult1 = ICSSStyleDeclaration, TResult2 = never>(
			onfulfilled?:
				| ((value: ICSSStyleDeclaration) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				CSSStyleDeclarationPropertyKeys,
				CSSStyleDeclarationConstantKeys,
			);
		}
	};
}
...
export const CSSStyleDeclarationPropertyKeys = [
	"cssFloat",
	"cssText",
	"length",
	"parentRule",
