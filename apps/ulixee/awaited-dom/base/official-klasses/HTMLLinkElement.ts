...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLLinkElement>(
	"HTMLLinkElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLLinkElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLLinkElementGenerator(
	...
	return class HTMLLinkElement
		extends Parent
		implements IHTMLLinkElement, PromiseLike<IHTMLLinkElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IHTMLLinkElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLLinkElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLLinkElementPropertyKeys,
				HTMLLinkElementConstantKeys,
			);
		}
	};
}
...
export interface IHTMLLinkElementProperties
...
export const HTMLLinkElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	...LinkStylePropertyKeys,
	"as",
	"crossOrigin",
...
export const HTMLLinkElementConstantKeys = [
	...HTMLElementConstantKeys,
	...LinkStyleConstantKeys,
];
