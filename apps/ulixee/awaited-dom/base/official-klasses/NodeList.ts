...
import type { INodeList } from "../interfaces/official";
...
export const { getState, setState } = StateMachine<
	...
	INodeListProperties
>();
export const awaitedHandler = new AwaitedHandler<INodeList>(
	"NodeList",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<INodeList>(
	getState,
	setState,
	awaitedHandler,
);
export const awaitedIterator = new AwaitedIterator<INodeList, ISuperNode>(
	getState,
	setState,
	awaitedHandler,
);
...
export function NodeListGenerator() {
	return class NodeList implements INodeList, PromiseLike<INodeList> {
		...
		public then<TResult1 = INodeList, TResult2 = never>(
			onfulfilled?:
				| ((value: INodeList) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				NodeListPropertyKeys,
				NodeListConstantKeys,
			);
		}
	};
}
