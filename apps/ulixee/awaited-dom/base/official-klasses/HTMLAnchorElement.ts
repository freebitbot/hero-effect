...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLAnchorElement>(
	"HTMLAnchorElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLAnchorElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLAnchorElementGenerator(
	...
	return class HTMLAnchorElement
		extends Parent
		implements IHTMLAnchorElement, PromiseLike<IHTMLAnchorElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IHTMLAnchorElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLAnchorElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLAnchorElementPropertyKeys,
				HTMLAnchorElementConstantKeys,
			);
		}
	};
}
...
export interface IHTMLAnchorElementProperties
...
export const HTMLAnchorElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	...HTMLHyperlinkElementUtilsPropertyKeys,
	"download",
	"hreflang",
...
export const HTMLAnchorElementConstantKeys = [
	...HTMLElementConstantKeys,
	...HTMLHyperlinkElementUtilsConstantKeys,
];
