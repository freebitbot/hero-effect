...
import type { IXPathResult } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IXPathResult>(
	"XPathResult",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IXPathResult>(
	getState,
	setState,
	awaitedHandler,
);
...
export function XPathResultGenerator() {
	return class XPathResult implements IXPathResult, PromiseLike<IXPathResult> {
		...
		public then<TResult1 = IXPathResult, TResult2 = never>(
			onfulfilled?:
				| ((value: IXPathResult) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				XPathResultPropertyKeys,
				XPathResultConstantKeys,
			);
		}
	};
}
...
export const XPathResultPropertyKeys = [
	"booleanValue",
	"invalidIteratorState",
	"numberValue",
	"resultType",
...
export const XPathResultConstantKeys = [
	"ANY_TYPE",
