...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLButtonElement>(
	"HTMLButtonElement",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<IHTMLButtonElement>(
	getState,
	setState,
	awaitedHandler,
);

export function HTMLButtonElementGenerator(
	HTMLElement: Constructable<IHTMLElement>,
) {
	return class HTMLButtonElement
		extends HTMLElement
		implements IHTMLButtonElement, PromiseLike<IHTMLButtonElement>
	{
		constructor() {
			super();
			setState(this, {
		...
		public then<TResult1 = IHTMLButtonElement, TResult2 = never>(
			onfulfilled?:
				| ((value: IHTMLButtonElement) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				HTMLButtonElementPropertyKeys,
				HTMLButtonElementConstantKeys,
			);
		}
	};
}
...
export const HTMLButtonElementPropertyKeys = [
	...HTMLElementPropertyKeys,
	"autofocus",
	"disabled",
	"form",
