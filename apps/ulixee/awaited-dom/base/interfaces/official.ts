...
import type { INodeIsolate } from "./isolate";
import type {
	ISuperDocument,
	ISuperElement,
...
export type IRequestDestination =
	| ""
	| "audio"
	| "audioworklet"
	| "document"
...
export interface IDOMTokenList {
	...
	forEach(
		callbackfn: (value: string, key: number, parent: IDOMTokenList) => void,
		thisArg?: any,
	): Promise<void>;
...
export interface INodeList {
	...
	forEach(
		callbackfn: (value: ISuperNode, key: number, parent: INodeList) => void,
		thisArg?: any,
	): Promise<void>;
...
export interface ISelection {
	...
	setBaseAndExtent(
		anchorNode: INodeIsolate,
		anchorOffset: number,
		focusNode: INodeIsolate,
		focusOffset: number,
	): Promise<void>;
...
export type IValidityState = {};

// VideoPlaybackQuality //////////

export type IVideoPlaybackQuality = {};
...
export interface IHTMLAnchorElement
...
export interface IHTMLAreaElement
	extends IHTMLElement,
		IHTMLElement,
		IHTMLHyperlinkElementUtils {
