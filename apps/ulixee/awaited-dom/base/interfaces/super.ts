...
export interface ISuperElement
	extends IElementCSSInlineStyle,
		IElementContentEditable,
		IElementIsolate,
		IHTMLAnchorElementIsolate,
		IHTMLAreaElementIsolate,
...
export interface ISuperHTMLCollection
	extends IHTMLCollectionBaseIsolate,
		IHTMLCollectionIsolate,
		IHTMLOptionsCollectionIsolate {
...
export interface ISuperHTMLElement
	extends IElementCSSInlineStyle,
		IElementContentEditable,
		IElementIsolate,
		IHTMLAnchorElementIsolate,
