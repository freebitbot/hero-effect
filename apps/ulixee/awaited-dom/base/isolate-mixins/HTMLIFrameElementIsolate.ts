...
import type { IHTMLIFrameElementIsolate } from "../interfaces/isolate";
import type { IDOMTokenList, IFeaturePolicy } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLIFrameElementIsolate>(
	...
	implements IHTMLIFrameElementIsolate
{
	...
	public get contentDocument(): ISuperDocument {
		throw new Error(
			"HTMLIFrameElementIsolate.contentDocument getter not implemented",
		);
	}
	...
	public get featurePolicy(): IFeaturePolicy {
		throw new Error(
			"HTMLIFrameElementIsolate.featurePolicy getter not implemented",
		);
	}
...
export const HTMLIFrameElementIsolatePropertyKeys = [
	"align",
	"allow",
	"allowFullscreen",
	"allowPaymentRequest",
