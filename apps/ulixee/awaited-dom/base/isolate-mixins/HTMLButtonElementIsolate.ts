...
import type { IHTMLButtonElementIsolate } from "../interfaces/isolate";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLButtonElementIsolate>(
	"HTMLButtonElementIsolate",
	getState,
	setState,
);

export default class HTMLButtonElementIsolate
...
export const HTMLButtonElementIsolatePropertyKeys = [
	"autofocus",
	"disabled",
	"form",
	"formAction",
