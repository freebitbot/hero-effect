...
import type { IHTMLVideoElementIsolate } from "../interfaces/isolate";
import type { IVideoPlaybackQuality } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLVideoElementIsolate>(
	...
	implements IHTMLVideoElementIsolate
{
	...
	public getVideoPlaybackQuality(): IVideoPlaybackQuality {
		throw new Error(
			"HTMLVideoElementIsolate.getVideoPlaybackQuality not implemented",
		);
	}
}
...
export const HTMLVideoElementIsolatePropertyKeys = [
	"height",
	"poster",
	"videoHeight",
	"videoWidth",
