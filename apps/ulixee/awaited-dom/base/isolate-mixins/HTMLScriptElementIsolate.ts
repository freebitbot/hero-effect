...
import type { IHTMLScriptElementIsolate } from "../interfaces/isolate";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLScriptElementIsolate>(
...
export const HTMLScriptElementIsolatePropertyKeys = [
	"async",
	"charset",
	"crossOrigin",
	"defer",
