...
import type { IHTMLMediaElementIsolate } from "../interfaces/isolate";
import type {
	IAudioTrackList,
	ICanPlayTypeResult,
	IDOMTokenList,
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLMediaElementIsolate>(
	...
	implements IHTMLMediaElementIsolate
{
	...
	public get audioTracks(): IAudioTrackList {
		throw new Error(
			"HTMLMediaElementIsolate.audioTracks getter not implemented",
		);
	}
	...
	public get controlsList(): IDOMTokenList {
		throw new Error(
			"HTMLMediaElementIsolate.controlsList getter not implemented",
		);
	}
	...
	public get defaultPlaybackRate(): Promise<number> {
		return awaitedHandler.getProperty<number>(
			this,
			"defaultPlaybackRate",
			false,
		);
	...
	public get textTracks(): ITextTrackList {
		throw new Error(
			"HTMLMediaElementIsolate.textTracks getter not implemented",
		);
	}

	public get videoTracks(): IVideoTrackList {
		throw new Error(
			"HTMLMediaElementIsolate.videoTracks getter not implemented",
		);
	}
	...
	public canPlayType(type: string): Promise<ICanPlayTypeResult> {
		return awaitedHandler.runMethod<ICanPlayTypeResult>(this, "canPlayType", [
			type,
		]);
	}
...
export const HTMLMediaElementIsolatePropertyKeys = [
	"audioTracks",
	"autoplay",
	"buffered",
	"controls",
...
export const HTMLMediaElementIsolateConstantKeys = [
	"HAVE_CURRENT_DATA",
	"HAVE_ENOUGH_DATA",
	"HAVE_FUTURE_DATA",
	"HAVE_METADATA",
