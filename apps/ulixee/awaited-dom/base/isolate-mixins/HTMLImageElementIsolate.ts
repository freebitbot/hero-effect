...
import type { IHTMLImageElementIsolate } from "../interfaces/isolate";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLImageElementIsolate>(
...
export const HTMLImageElementIsolatePropertyKeys = [
	"alt",
	"complete",
	"crossOrigin",
	"currentSrc",
