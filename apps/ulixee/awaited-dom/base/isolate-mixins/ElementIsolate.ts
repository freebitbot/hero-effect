...
import type { IElementIsolate } from "../interfaces/isolate";
import type {
	IAttr,
	IDOMRect,
	IDOMRectList,
...
>();
export const awaitedHandler = new AwaitedHandler<IElementIsolate>(
	"ElementIsolate",
	getState,
	setState,
);
...
export default class ElementIsolate implements IElementIsolate {
	...
	public getAttributeNodeNS(
		...
		return awaitedHandler.runMethod<IAttr | null>(this, "getAttributeNodeNS", [
			namespace,
			localName,
		]);
	}
...
export const ElementIsolatePropertyKeys = [
	"attributes",
	"classList",
	"className",
	"clientHeight",
