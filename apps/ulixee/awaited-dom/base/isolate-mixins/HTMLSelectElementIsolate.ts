...
import type { IHTMLSelectElementIsolate } from "../interfaces/isolate";
import type {
	IHTMLFormElement,
	IHTMLOptionElement,
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLSelectElementIsolate>(
...
export default class HTMLSelectElementIsolate
	implements IHTMLSelectElementIsolate
{
	...
	public get selectedOptions(): ISuperHTMLCollection {
		throw new Error(
			"HTMLSelectElementIsolate.selectedOptions getter not implemented",
		);
	}
...
export const HTMLSelectElementIsolatePropertyKeys = [
	"autocomplete",
	"autofocus",
	"disabled",
	"form",
