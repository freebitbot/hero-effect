...
import type { IDocumentIsolate } from "../interfaces/isolate";
import type {
	IDOMImplementation,
	IDocumentReadyState,
	IDocumentType,
...
>();
export const awaitedHandler = new AwaitedHandler<IDocumentIsolate>(
	"DocumentIsolate",
	getState,
	setState,
);
...
export const DocumentIsolatePropertyKeys = [
	"URL",
	"anchors",
	"body",
	"characterSet",
