...
import type { IHTMLTableColElementIsolate } from "../interfaces/isolate";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLTableColElementIsolate>(
...
export const HTMLTableColElementIsolatePropertyKeys = [
	"align",
	"ch",
	"chOff",
	"span",
