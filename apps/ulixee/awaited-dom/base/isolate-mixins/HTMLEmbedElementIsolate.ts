...
import type { IHTMLEmbedElementIsolate } from "../interfaces/isolate";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLEmbedElementIsolate>(
...
export const HTMLEmbedElementIsolatePropertyKeys = [
	"align",
	"height",
	"name",
	"src",
