...
import type { IHTMLOptionElementIsolate } from "../interfaces/isolate";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLOptionElementIsolate>(
...
export const HTMLOptionElementIsolatePropertyKeys = [
	"defaultSelected",
	"disabled",
	"form",
	"index",
