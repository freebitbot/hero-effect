...
import type { IHTMLTableElementIsolate } from "../interfaces/isolate";
import type {
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLTableElementIsolate>(
...
export const HTMLTableElementIsolatePropertyKeys = [
	"align",
	"bgColor",
	"border",
	"caption",
