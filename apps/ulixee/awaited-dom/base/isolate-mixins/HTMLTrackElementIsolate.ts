...
import type { IHTMLTrackElementIsolate } from "../interfaces/isolate";
import type { IDocumentReadyState, ITextTrack } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLTrackElementIsolate>(
...
export const HTMLTrackElementIsolatePropertyKeys = [
	"default",
	"kind",
	"label",
	"readyState",
...
export const HTMLTrackElementIsolateConstantKeys = [
	"ERROR",
	"LOADED",
	"LOADING",
	"NONE",
