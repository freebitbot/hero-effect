...
import type { IHTMLElementIsolate } from "../interfaces/isolate";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLElementIsolate>(
	"HTMLElementIsolate",
	getState,
	setState,
);
...
export const HTMLElementIsolatePropertyKeys = [
	"accessKey",
	"autoCapitalize",
	"dir",
	"draggable",
