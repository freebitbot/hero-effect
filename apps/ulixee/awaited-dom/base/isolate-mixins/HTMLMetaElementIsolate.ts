...
import type { IHTMLMetaElementIsolate } from "../interfaces/isolate";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLMetaElementIsolate>(
...
export const HTMLMetaElementIsolatePropertyKeys = [
	"content",
	"httpEquiv",
	"name",
	"scheme",
