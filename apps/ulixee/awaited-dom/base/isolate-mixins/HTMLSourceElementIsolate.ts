...
import type { IHTMLSourceElementIsolate } from "../interfaces/isolate";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLSourceElementIsolate>(
...
export const HTMLSourceElementIsolatePropertyKeys = [
	"media",
	"sizes",
	"src",
	"srcset",
