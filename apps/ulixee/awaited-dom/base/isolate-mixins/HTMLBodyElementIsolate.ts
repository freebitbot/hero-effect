...
import type { IHTMLBodyElementIsolate } from "../interfaces/isolate";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLBodyElementIsolate>(
...
export const HTMLBodyElementIsolatePropertyKeys = [
	"aLink",
	"background",
	"bgColor",
	"link",
