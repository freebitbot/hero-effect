...
import type { IHTMLAnchorElementIsolate } from "../interfaces/isolate";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLAnchorElementIsolate>(
...
export const HTMLAnchorElementIsolatePropertyKeys = [
	"download",
	"hreflang",
	"referrerPolicy",
	"rel",
