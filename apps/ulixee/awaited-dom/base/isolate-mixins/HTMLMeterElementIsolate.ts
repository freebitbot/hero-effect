...
import type { IHTMLMeterElementIsolate } from "../interfaces/isolate";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLMeterElementIsolate>(
...
export const HTMLMeterElementIsolatePropertyKeys = [
	"high",
	"labels",
	"low",
	"max",
