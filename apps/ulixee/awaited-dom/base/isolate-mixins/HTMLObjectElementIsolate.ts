...
import type { IHTMLObjectElementIsolate } from "../interfaces/isolate";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLObjectElementIsolate>(
	...
	implements IHTMLObjectElementIsolate
{
	...
	public get contentDocument(): ISuperDocument {
		throw new Error(
			"HTMLObjectElementIsolate.contentDocument getter not implemented",
		);
	}
...
export const HTMLObjectElementIsolatePropertyKeys = [
	"align",
	"archive",
	"border",
	"code",
