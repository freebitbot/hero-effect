...
import type { IShadowRootIsolate } from "../interfaces/isolate";
import type { IShadowRootMode } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IShadowRootIsolate>(
	"ShadowRootIsolate",
	getState,
	setState,
);
...
export const ShadowRootIsolatePropertyKeys = [
	"delegatesFocus",
	"host",
	"innerHTML",
	"mode",
