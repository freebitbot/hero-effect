...
import type { IHTMLParamElementIsolate } from "../interfaces/isolate";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLParamElementIsolate>(
...
export const HTMLParamElementIsolatePropertyKeys = [
	"name",
	"type",
	"value",
	"valueType",
