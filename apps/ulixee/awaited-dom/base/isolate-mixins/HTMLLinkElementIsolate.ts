...
import type { IHTMLLinkElementIsolate } from "../interfaces/isolate";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLLinkElementIsolate>(
...
export const HTMLLinkElementIsolatePropertyKeys = [
	"as",
	"crossOrigin",
	"href",
	"hreflang",
