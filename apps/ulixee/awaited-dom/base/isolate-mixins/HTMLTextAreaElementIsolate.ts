...
import type { IHTMLTextAreaElementIsolate } from "../interfaces/isolate";
import type {
	IHTMLFormElement,
	ISelectionMode,
	IValidityState,
} from "../interfaces/official";
import type { ISuperHTMLCollection, ISuperNodeList } from "../interfaces/super";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLTextAreaElementIsolate>(
...
export const HTMLTextAreaElementIsolatePropertyKeys = [
	"autocomplete",
	"autofocus",
	"cols",
	"defaultValue",
