...
import type { IGetRootNodeOptions } from "../interfaces/official";
import type {
	ISuperDocument,
	ISuperElement,
	ISuperNode,
...
>();
export const awaitedHandler = new AwaitedHandler<INodeIsolate>(
	"NodeIsolate",
	getState,
	setState,
);
...
export default class NodeIsolate implements INodeIsolate {
	...
	public lookupNamespaceURI(prefix: string | null): Promise<string | null> {
		return awaitedHandler.runMethod<string | null>(this, "lookupNamespaceURI", [
			prefix,
		]);
	}
...
export const NodeIsolatePropertyKeys = [
	"baseURI",
	"childNodes",
	"firstChild",
	"isConnected",
...
export const NodeIsolateConstantKeys = [
	"ATTRIBUTE_NODE",
	"CDATA_SECTION_NODE",
	"COMMENT_NODE",
