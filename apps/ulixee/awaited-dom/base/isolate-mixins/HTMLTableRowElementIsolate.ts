...
import type { IHTMLTableRowElementIsolate } from "../interfaces/isolate";
import type { IHTMLTableCellElement } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLTableRowElementIsolate>(
...
export const HTMLTableRowElementIsolatePropertyKeys = [
	"align",
	"bgColor",
	"cells",
	"ch",
