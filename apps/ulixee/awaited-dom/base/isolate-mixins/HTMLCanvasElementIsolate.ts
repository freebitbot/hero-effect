...
import type { IHTMLCanvasElementIsolate } from "../interfaces/isolate";
import type { IMediaStream, IOffscreenCanvas } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLCanvasElementIsolate>(
	...
	implements IHTMLCanvasElementIsolate
{
	...
	public transferControlToOffscreen(): IOffscreenCanvas {
		throw new Error(
			"HTMLCanvasElementIsolate.transferControlToOffscreen not implemented",
		);
	}
}
