...
import type { IHTMLFieldSetElementIsolate } from "../interfaces/isolate";
import type { IHTMLFormElement, IValidityState } from "../interfaces/official";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLFieldSetElementIsolate>(
	...
	implements IHTMLFieldSetElementIsolate
{
	...
	public get elements(): ISuperHTMLCollection {
		throw new Error(
			"HTMLFieldSetElementIsolate.elements getter not implemented",
		);
	}
...
export const HTMLFieldSetElementIsolatePropertyKeys = [
	"disabled",
	"elements",
	"form",
	"name",
