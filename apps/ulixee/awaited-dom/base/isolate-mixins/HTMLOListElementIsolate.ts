...
import type { IHTMLOListElementIsolate } from "../interfaces/isolate";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLOListElementIsolate>(
...
export const HTMLOListElementIsolatePropertyKeys = [
	"compact",
	"reversed",
	"start",
	"type",
