...
import type { IHTMLAreaElementIsolate } from "../interfaces/isolate";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLAreaElementIsolate>(
...
export const HTMLAreaElementIsolatePropertyKeys = [
	"alt",
	"coords",
	"download",
	"hreflang",
