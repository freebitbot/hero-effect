...
import type { IHTMLFrameElementIsolate } from "../interfaces/isolate";
...
>();
export const awaitedHandler = new AwaitedHandler<IHTMLFrameElementIsolate>(
	...
	implements IHTMLFrameElementIsolate
{
	public get contentDocument(): ISuperDocument {
		throw new Error(
			"HTMLFrameElementIsolate.contentDocument getter not implemented",
		);
	}
...
export const HTMLFrameElementIsolatePropertyKeys = [
	"contentDocument",
	"frameBorder",
	"longDesc",
	"marginHeight",
