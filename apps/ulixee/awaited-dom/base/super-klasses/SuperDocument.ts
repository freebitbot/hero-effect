...
>();
export const awaitedHandler = new AwaitedHandler<ISuperDocument>(
	"SuperDocument",
	getState,
	setState,
);
export const nodeFactory = new NodeFactory<ISuperDocument>(
	getState,
	setState,
	awaitedHandler,
);
...
export function SuperDocumentGenerator(
	...
	const Parent = ClassMixer(DocumentIsolate, [
	...
	return class SuperDocument
		extends Parent
		implements ISuperDocument, PromiseLike<ISuperDocument>
	{
		constructor() {
			super();
			setState(this, {
		...
		public get readyState(): Promise<IDocumentReadyState> {
			return awaitedHandler.getProperty<IDocumentReadyState>(
				this,
				"readyState",
				false,
			);
		...
		public get visibilityState(): Promise<IVisibilityState> {
			return awaitedHandler.getProperty<IVisibilityState>(
				this,
				"visibilityState",
				false,
			);
		...
		public then<TResult1 = ISuperDocument, TResult2 = never>(
			onfulfilled?:
				| ((value: ISuperDocument) => PromiseLike<TResult1> | TResult1)
				| undefined
				| null,
			onrejected?:
		...
		public [Symbol.for("nodejs.util.inspect.custom")]() {
			return inspectInstanceProperties(
				this,
				SuperDocumentPropertyKeys,
				SuperDocumentConstantKeys,
			);
		}
	};
}
...
export interface ISuperDocumentProperties
	extends IDocumentIsolateProperties,
...
export const SuperDocumentPropertyKeys = [
	...DocumentIsolatePropertyKeys,
	...DocumentOrShadowRootPropertyKeys,
	...HTMLDocumentIsolatePropertyKeys,
	...NodeIsolatePropertyKeys,
