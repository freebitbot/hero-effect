...
import type ICommandMarker from "@ulixee/unblocked-agent/interfaces/ICommandMarker";
import type SessionDb from "../dbs/SessionDb";
import type { IRemoteEmitFn } from "../interfaces/IRemoteEventListener";
import type { IEventRecord } from "../models/AwaitedEventsTable";
	...
	implements ICommandMarker
{
	...
	public willRunCommand(newCommand: ICommandMeta): void {
		...
		if (
			!newCommand.name.startsWith("waitFor") ||
	...
	public getCommandForTimestamp(
		lastCommand: ICommandMeta,
		timestamp: number,
	): ICommandMeta {
