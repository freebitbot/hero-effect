...
type DomNodeOrPromiseValue<T> =
	T extends PromiseLike<infer R> ? R : T extends IAwaitedNode ? T : never;
...
export type IStateAndAssertion<T> = [
	statePromise: T,
	assertionFnOrValue?:
		| ((state: DomNodeOrPromiseValue<T>) => boolean)
		| DomNodeOrPromiseValue<T>,
];
