...
export default function loadDomOverrides(
	...
	domOverrides.addOverrideAndUseConfig(InjectedScript.CONSOLE, undefined, {
		registerWorkerOverride: true,
	});
	...
	domOverrides.addOverrideAndUseConfig(
		InjectedScript.NAVIGATOR,
		{
			...
			headless: isHeadless,
			pdfViewerEnabled:
				data.windowNavigator.navigator.pdfViewerEnabled?._$value,
			userAgentData,
	...
	domOverrides.addOverrideAndUseConfig(
		InjectedScript.SHAREDWORKER_PROTOTYPE,
		undefined,
		{
			registerWorkerOverride: true,
		},
	...
	domOverrides.addOverrideAndUseConfig(
		InjectedScript.SPEECH_SYNTHESIS_GETVOICES,
		{ voices },
	);
	...
	domOverrides.addOverrideAndUseConfig(
		...
		{
			preventDefaultUncaughtError: true,
