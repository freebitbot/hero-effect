...
export function main({
	args,
	utils: { ReflectCached, replaceFunction },
}: ScriptInput<Args>) {
	...
	for (const context of [
		...
		replaceFunction(context, "getExtension", (target, thisArg, argArray) => {
		...
		replaceFunction(context, "getParameter", (target, thisArg, argArray) => {
