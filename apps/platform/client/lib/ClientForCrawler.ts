import type { Crawler } from "@ulixee/datastore";
import type ICrawlerOutputSchema from "@ulixee/datastore/interfaces/ICrawlerOutputSchema";
import type { IDatastoreBinding } from "@ulixee/datastore/lib/DatastoreInternal";
...
export default class ClientForCrawler<TCrawler extends Crawler> {
	...
	public crawl(
		inputFilter: TCrawler["schemaType"]["input"],
