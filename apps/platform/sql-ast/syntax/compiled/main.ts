...
const last = (x: any[]) =>
	Array.isArray(x) ? track(x[x.length - 1], x[x.length - 1]) : x;
...
const eqInsensitive = (a: string, b: string) =>
	(a.localeCompare as any)(b, undefined, kwSensitivity) === 0;
...
const grammar: Grammar = {
	...
	ParserRules: [
		{
			name: "lparen",
			symbols: [lexerAny.has("lparen") ? { type: "lparen" } : lparen],
		},
		{
			name: "rparen",
			symbols: [lexerAny.has("rparen") ? { type: "rparen" } : rparen],
		},
		...
		{
			name: "dot",
			symbols: [lexerAny.has("dot") ? { type: "dot" } : dot],
			postprocess: id,
		},
		{
			name: "float",
			symbols: [lexerAny.has("float") ? { type: "float" } : float],
			postprocess: (x) => box(x, parseFloat(unwrap(x))),
		},
		{
			name: "int",
			symbols: [lexerAny.has("int") ? { type: "int" } : int],
			postprocess: (x) => box(x, parseInt(unwrap(x), 10)),
		},
		{
			name: "comma",
			symbols: [lexerAny.has("comma") ? { type: "comma" } : comma],
			postprocess: id,
		},
		{
			name: "star",
			symbols: [lexerAny.has("star") ? { type: "star" } : star],
			postprocess: (x) => box(x, x[0].value),
		},
		{
			name: "string$subexpression$1",
			symbols: [lexerAny.has("string") ? { type: "string" } : string],
		},
		{
			name: "string$subexpression$1",
			symbols: [lexerAny.has("eString") ? { type: "eString" } : eString],
		},
		{
			name: "string",
		...
		{ name: "ident", symbols: ["word"], postprocess: get(0) },
		{
			name: "word",
			symbols: [
				lexerAny.has("kw_primary") ? { type: "kw_primary" } : kw_primary,
			],
			postprocess: (x) => box(x, "primary"),
		},
		{
			name: "word",
			symbols: [lexerAny.has("kw_unique") ? { type: "kw_unique" } : kw_unique],
			postprocess: (x) => box(x, "unique"),
		},
		{
			name: "word",
			symbols: [
				lexerAny.has("quoted_word") ? { type: "quoted_word" } : quoted_word,
			],
			postprocess: (x) => box(x, x[0].value, true),
		},
		{
			name: "word",
			symbols: [lexerAny.has("word") ? { type: "word" } : word],
			postprocess: (x) => box(x, x[0].value),
		},
		{
			name: "collist_paren",
			symbols: ["lparen", "collist", "rparen"],
			postprocess: get(1),
		},
		...
		{
			name: "collist$ebnf$1",
			symbols: ["collist$ebnf$1", "collist$ebnf$1$subexpression$1"],
			postprocess: (d) => d[0].concat([d[1]]),
		},
		{
			name: "collist",
			symbols: ["ident", "collist$ebnf$1"],
		...
		},
		{
			...
			symbols: [
				"kw_if",
				lexerAny.has("kw_not") ? { type: "kw_not" } : kw_not,
				"kw_exists",
			],
		},
		{ name: "kw_ifexists", symbols: ["kw_if", "kw_exists"] },
		{
			...
			symbols: [
				lexerAny.has("kw_with") ? { type: "kw_with" } : kw_with,
				"kw_ordinality",
			],
		},
		{
			...
			symbols: [
				lexerAny.has("kw_not") ? { type: "kw_not" } : kw_not,
				lexerAny.has("kw_null") ? { type: "kw_null" } : kw_null,
			],
		},
		{
			name: "kw_primary_key",
		...
		},
		{
			...
			symbols: [
				lexerAny.has("comma") ? { type: "comma" } : comma,
		...
		},
		{
			...
			symbols: ["data_type$ebnf$1$subexpression$1"],
			postprocess: id,
		},
		{ name: "data_type$ebnf$1", symbols: [], postprocess: () => null },
		{
			name: "data_type$ebnf$2$subexpression$1",
			symbols: [lexerAny.has("kw_array") ? { type: "kw_array" } : kw_array],
		},
		{
			name: "data_type$ebnf$2$subexpression$1$ebnf$1$subexpression$1",
			symbols: [
				lexerAny.has("lbracket") ? { type: "lbracket" } : lbracket,
				lexerAny.has("rbracket") ? { type: "rbracket" } : rbracket,
			],
		},
		{
			name: "data_type$ebnf$2$subexpression$1$ebnf$1",
			symbols: ["data_type$ebnf$2$subexpression$1$ebnf$1$subexpression$1"],
		},
		{
		...
		{
			name: "data_type$ebnf$2$subexpression$1",
			symbols: ["data_type$ebnf$2$subexpression$1$ebnf$1"],
		},
		{
			name: "data_type$ebnf$2",
			symbols: ["data_type$ebnf$2$subexpression$1"],
			postprocess: id,
		},
		{ name: "data_type$ebnf$2", symbols: [], postprocess: () => null },
		{
			name: "data_type",
			symbols: ["data_type_simple", "data_type$ebnf$1", "data_type$ebnf$2"],
			postprocess: (x) => {
				let asArray = x[2];
		...
		{
			name: "data_type_list",
			symbols: ["data_type", "data_type_list$ebnf$1"],
			postprocess: ([head, tail]) => {
				return [head, ...(tail || [])];
			},
		},
		{
			...
			symbols: ["data_type_text"],
			postprocess: (x) => track(x, { name: toStr(x, " ") }),
		},
		{
			name: "data_type_simple",
			symbols: ["data_type_numeric"],
			postprocess: (x) => track(x, { name: toStr(x, " ") }),
		},
		...
		},
		{
			...
			symbols: [
				...
				lexerAny.has("kw_precision") ? { type: "kw_precision" } : kw_precision,
			],
		},
		{
		...
		},
		{
			...
			symbols: [lexerAny.has("kw_with") ? { type: "kw_with" } : kw_with],
		},
		{
			name: "data_type_date$subexpression$2",
			symbols: [lexerAny.has("word") ? { type: "word" } : word],
		...
		},
		{
			...
			symbols: [lexerAny.has("kw_as") ? { type: "kw_as" } : kw_as, "ident"],
			postprocess: last,
		},
		...
		{
			name: "qcolumn$ebnf$1",
			symbols: ["qcolumn$ebnf$1$subexpression$1"],
			postprocess: id,
		},
		{ name: "qcolumn$ebnf$1", symbols: [], postprocess: () => null },
		{
			name: "qcolumn",
			symbols: ["ident", "dot", "ident", "qcolumn$ebnf$1"],
			postprocess: (x) => {
				if (!x[3]) {
					return track(x, {
						table: unbox(x[0]),
		...
		{
			name: "qualified_name",
			symbols: ["ident", "dot", "ident_extended"],
			postprocess: (x) => {
		...
		},
		{
			...
			postprocess: (x) => track(x, { name: "current_schema" }),
		},
		{
			name: "qualified_name_mark_quotes",
			symbols: ["qname_ident"],
			postprocess: (x) => track(x, { name: toStr(x), ...doubleQuoted(x) }),
		},
		{
			name: "qualified_name_mark_quotes",
			symbols: ["ident", "dot", "ident_extended"],
		...
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_all") ? { type: "kw_all" } : kw_all],
		},
		{
			name: "any_keyword",
			symbols: [
				lexerAny.has("kw_analyse") ? { type: "kw_analyse" } : kw_analyse,
			],
		},
		{
			name: "any_keyword",
			symbols: [
				lexerAny.has("kw_analyze") ? { type: "kw_analyze" } : kw_analyze,
			],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_and") ? { type: "kw_and" } : kw_and],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_any") ? { type: "kw_any" } : kw_any],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_array") ? { type: "kw_array" } : kw_array],
		...
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_as") ? { type: "kw_as" } : kw_as],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_asc") ? { type: "kw_asc" } : kw_asc],
		},
		{
			name: "any_keyword",
			symbols: [
		...
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_binary") ? { type: "kw_binary" } : kw_binary],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_both") ? { type: "kw_both" } : kw_both],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_case") ? { type: "kw_case" } : kw_case],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_cast") ? { type: "kw_cast" } : kw_cast],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_check") ? { type: "kw_check" } : kw_check],
		},
		{
			name: "any_keyword",
			symbols: [
				lexerAny.has("kw_collate") ? { type: "kw_collate" } : kw_collate,
			],
		},
		{
			name: "any_keyword",
			symbols: [
				lexerAny.has("kw_collation") ? { type: "kw_collation" } : kw_collation,
			],
		},
		{
			name: "any_keyword",
		...
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_cross") ? { type: "kw_cross" } : kw_cross],
		},
		{
			name: "any_keyword",
			symbols: [
		...
		},
		{
			name: "any_keyword",
			symbols: [
				lexerAny.has("kw_default") ? { type: "kw_default" } : kw_default,
			],
		},
		{
			name: "any_keyword",
		...
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_desc") ? { type: "kw_desc" } : kw_desc],
		},
		{
			name: "any_keyword",
			symbols: [
				lexerAny.has("kw_distinct") ? { type: "kw_distinct" } : kw_distinct,
			],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_else") ? { type: "kw_else" } : kw_else],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_end") ? { type: "kw_end" } : kw_end],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_false") ? { type: "kw_false" } : kw_false],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_fetch") ? { type: "kw_fetch" } : kw_fetch],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_for") ? { type: "kw_for" } : kw_for],
		},
		{
			name: "any_keyword",
			symbols: [
				lexerAny.has("kw_foreign") ? { type: "kw_foreign" } : kw_foreign,
			],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_freeze") ? { type: "kw_freeze" } : kw_freeze],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_from") ? { type: "kw_from" } : kw_from],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_full") ? { type: "kw_full" } : kw_full],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_grant") ? { type: "kw_grant" } : kw_grant],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_group") ? { type: "kw_group" } : kw_group],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_having") ? { type: "kw_having" } : kw_having],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_ilike") ? { type: "kw_ilike" } : kw_ilike],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_in") ? { type: "kw_in" } : kw_in],
		},
		{
			name: "any_keyword",
			symbols: [
				lexerAny.has("kw_initially") ? { type: "kw_initially" } : kw_initially,
			],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_inner") ? { type: "kw_inner" } : kw_inner],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_into") ? { type: "kw_into" } : kw_into],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_is") ? { type: "kw_is" } : kw_is],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_isnull") ? { type: "kw_isnull" } : kw_isnull],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_join") ? { type: "kw_join" } : kw_join],
		},
		{
			name: "any_keyword",
			symbols: [
				lexerAny.has("kw_lateral") ? { type: "kw_lateral" } : kw_lateral,
			],
		},
		{
			name: "any_keyword",
			symbols: [
				lexerAny.has("kw_leading") ? { type: "kw_leading" } : kw_leading,
			],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_left") ? { type: "kw_left" } : kw_left],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_like") ? { type: "kw_like" } : kw_like],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_limit") ? { type: "kw_limit" } : kw_limit],
		},
		{
			name: "any_keyword",
			symbols: [
				lexerAny.has("kw_localtime") ? { type: "kw_localtime" } : kw_localtime,
			],
		},
		{
			name: "any_keyword",
		...
		},
		{
			name: "any_keyword",
			symbols: [
				lexerAny.has("kw_natural") ? { type: "kw_natural" } : kw_natural,
			],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_not") ? { type: "kw_not" } : kw_not],
		},
		{
			name: "any_keyword",
			symbols: [
				lexerAny.has("kw_notnull") ? { type: "kw_notnull" } : kw_notnull,
			],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_null") ? { type: "kw_null" } : kw_null],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_offset") ? { type: "kw_offset" } : kw_offset],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_on") ? { type: "kw_on" } : kw_on],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_only") ? { type: "kw_only" } : kw_only],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_or") ? { type: "kw_or" } : kw_or],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_order") ? { type: "kw_order" } : kw_order],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_outer") ? { type: "kw_outer" } : kw_outer],
		},
		{
			name: "any_keyword",
			symbols: [
				lexerAny.has("kw_overlaps") ? { type: "kw_overlaps" } : kw_overlaps,
			],
		},
		{
			name: "any_keyword",
			symbols: [
				lexerAny.has("kw_placing") ? { type: "kw_placing" } : kw_placing,
			],
		},
		{
			name: "any_keyword",
		...
		},
		{
			name: "any_keyword",
			symbols: [
				lexerAny.has("kw_returning") ? { type: "kw_returning" } : kw_returning,
			],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_right") ? { type: "kw_right" } : kw_right],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_select") ? { type: "kw_select" } : kw_select],
		},
		{
			name: "any_keyword",
			symbols: [
		...
		},
		{
			name: "any_keyword",
			symbols: [
				lexerAny.has("kw_similar") ? { type: "kw_similar" } : kw_similar,
			],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_some") ? { type: "kw_some" } : kw_some],
		},
		{
			name: "any_keyword",
			symbols: [
				lexerAny.has("kw_symmetric") ? { type: "kw_symmetric" } : kw_symmetric,
			],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_table") ? { type: "kw_table" } : kw_table],
		},
		{
			name: "any_keyword",
			symbols: [
		...
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_then") ? { type: "kw_then" } : kw_then],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_to") ? { type: "kw_to" } : kw_to],
		},
		{
			name: "any_keyword",
			symbols: [
				lexerAny.has("kw_trailing") ? { type: "kw_trailing" } : kw_trailing,
			],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_true") ? { type: "kw_true" } : kw_true],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_unique") ? { type: "kw_unique" } : kw_unique],
		...
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_user") ? { type: "kw_user" } : kw_user],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_using") ? { type: "kw_using" } : kw_using],
		},
		{
			name: "any_keyword",
			symbols: [
				lexerAny.has("kw_variadic") ? { type: "kw_variadic" } : kw_variadic,
			],
		},
		{
			name: "any_keyword",
			symbols: [
				lexerAny.has("kw_verbose") ? { type: "kw_verbose" } : kw_verbose,
			],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_when") ? { type: "kw_when" } : kw_when],
		},
		{
			name: "any_keyword",
			symbols: [lexerAny.has("kw_where") ? { type: "kw_where" } : kw_where],
		},
		...
		{ name: "select_statement$ebnf$6", symbols: [], postprocess: () => null },
		{
			...
			postprocess: (x) => {
				...
				groupBy =
					groupBy &&
					(groupBy.length === 1 && groupBy[0].type === "list"
						? groupBy[0].expressions
						: groupBy);
				return track(x, {
					...what,
		...
		{
			name: "selection_statement",
			symbols: ["select_values"],
			postprocess: unwrap,
		},
		{
			name: "selection_paren",
			symbols: ["lparen", "selection_statement", "rparen"],
			postprocess: get(1),
		},
		{
			name: "select_from",
			symbols: [
				lexerAny.has("kw_from") ? { type: "kw_from" } : kw_from,
				"select_from_items",
			],
			postprocess: last,
		},
		{ name: "select_from_items$ebnf$1", symbols: [] },
		{
			...
			symbols: ["comma", "select_from_item"],
			postprocess: last,
		},
		{
		...
		},
		{
			...
			symbols: ["select_from_item", "select_from_items$ebnf$1"],
			postprocess: ([head, tail]) => {
		...
		{ name: "select_from_item", symbols: ["select_from_subject"] },
		{
			...
			symbols: ["select_from_item_joins"],
			postprocess: get(0),
		},
		{
			name: "select_from_item_joins$subexpression$1",
			symbols: ["select_from_item"],
			postprocess: get(0),
		},
		{
			name: "select_from_item_joins",
			symbols: ["select_from_item_joins$subexpression$1", "select_table_join"],
			postprocess: flatten,
		},
		{
			name: "select_from_item_joins",
			symbols: ["lparen", "select_from_item_joins", "rparen"],
			postprocess: get(1),
		},
		{
		...
		{
			name: "stb_opts",
			symbols: ["ident_aliased", "stb_opts$ebnf$1"],
			postprocess: (x) =>
				track(x, {
					alias: toStr(x[0]),
		...
		{
			name: "stb_table",
			symbols: ["table_ref", "stb_table$ebnf$1"],
			postprocess: (x) => {
				return track(x, {
					type: "table",
					name: track(x, {
		...
		{
			name: "stb_statement",
			symbols: ["selection_paren", "stb_opts"],
			postprocess: (x) =>
				track(x, {
					type: "statement",
		...
		{
			name: "select_values",
			symbols: ["kw_values", "select_or_insert_values"],
			postprocess: (x) =>
				track(x, {
					type: "values",
					values: x[1],
		...
		{
			name: "select_or_insert_values$ebnf$1$subexpression$1",
			symbols: ["comma", "select_value"],
			postprocess: last,
		},
		{
			name: "select_or_insert_values$ebnf$1",
			symbols: [
				"select_or_insert_values$ebnf$1",
				"select_or_insert_values$ebnf$1$subexpression$1",
			],
			postprocess: (d) => d[0].concat([d[1]]),
		},
		{
			name: "select_or_insert_values",
			symbols: ["select_value", "select_or_insert_values$ebnf$1"],
			postprocess: ([head, tail]) => {
				return [head, ...(tail || [])];
			},
		},
		{
			name: "select_value",
			symbols: ["lparen", "select_expr_list_raw", "rparen"],
			postprocess: get(1),
		},
		{ name: "select_expr_list_raw$ebnf$1", symbols: [] },
		{
			name: "select_expr_list_raw$ebnf$1$subexpression$1",
			symbols: ["comma", "expr_or_select"],
			postprocess: last,
		},
		{
			name: "select_expr_list_raw$ebnf$1",
			symbols: [
				"select_expr_list_raw$ebnf$1",
				"select_expr_list_raw$ebnf$1$subexpression$1",
			],
			postprocess: (d) => d[0].concat([d[1]]),
		},
		{
			name: "select_expr_list_raw",
			symbols: ["expr_or_select", "select_expr_list_raw$ebnf$1"],
			postprocess: ([head, tail]) => {
				return [head, ...(tail || [])];
			},
		},
		...
		{
			name: "stb_call",
			symbols: ["expr_function_call", "stb_call$ebnf$1", "stb_call$ebnf$2"],
			postprocess: (x) => {
		...
		},
		{
			...
			symbols: ["stb_call_alias$subexpression$1$ebnf$1", "ident"],
			postprocess: last,
		},
		{
			name: "stb_call_alias$ebnf$1",
			symbols: ["stb_call_alias_list"],
			postprocess: id,
		},
		{ name: "stb_call_alias$ebnf$1", symbols: [], postprocess: () => null },
		{
			name: "stb_call_alias",
			symbols: ["stb_call_alias$subexpression$1", "stb_call_alias$ebnf$1"],
		},
		{
			name: "stb_call_alias_list",
			symbols: ["lparen", "stb_call_alias_list_raw", "rparen"],
			postprocess: get(1),
		},
		...
		},
		{
			...
			symbols: ["ident", "stb_call_alias_list_raw$ebnf$1"],
			postprocess: ([head, tail]) => {
				return [head, ...(tail || [])];
			},
		},
		{
			...
			symbols: ["select_table_join_clause"],
			postprocess: id,
		},
		{ name: "select_table_join$ebnf$1", symbols: [], postprocess: () => null },
		{
			...
			symbols: [
				"select_join_op",
				lexerAny.has("kw_join") ? { type: "kw_join" } : kw_join,
				"select_from_subject",
		...
		},
		{
			...
			symbols: [lexerAny.has("kw_on") ? { type: "kw_on" } : kw_on, "expr"],
			postprocess: (x) => track(x, { on: last(x) }),
		},
		...
		},
		{
			name: "select_table_join_clause",
			symbols: [
				lexerAny.has("kw_using") ? { type: "kw_using" } : kw_using,
				"lparen",
				"select_table_join_clause$macrocall$1",
				"rparen",
			],
			postprocess: (x) => track(x, { using: x[2].map(asName) }),
		},
		{
		...
		},
		{
			...
			symbols: ["select_join_op$subexpression$1$ebnf$1"],
		...
		},
		{
			...
			symbols: [
				lexerAny.has("kw_left") ? { type: "kw_left" } : kw_left,
		...
		},
		{
			...
			symbols: [
				lexerAny.has("kw_right") ? { type: "kw_right" } : kw_right,
		...
		},
		{
			...
			symbols: [
				lexerAny.has("kw_full") ? { type: "kw_full" } : kw_full,
		...
		{ name: "select_what$ebnf$2", symbols: [], postprocess: () => null },
		{
			name: "select_what",
			symbols: [
				lexerAny.has("kw_select") ? { type: "kw_select" } : kw_select,
				"select_what$ebnf$1",
				"select_what$ebnf$2",
			],
			postprocess: (x) =>
		...
		{ name: "select_expr_list_aliased$ebnf$1", symbols: [] },
		{
			...
			symbols: ["comma", "select_expr_list_item"],
			postprocess: last,
		},
		{
		...
		},
		{
			...
			symbols: ["select_expr_list_item", "select_expr_list_aliased$ebnf$1"],
			postprocess: ([head, tail]) => {
				return [head, ...(tail || [])];
			},
		},
		...
		},
		{
			...
			symbols: ["expr", "select_expr_list_item$ebnf$1"],
			postprocess: (x) =>
				track(x, {
					expr: x[0],
		...
		},
		{
			...
			symbols: [
				lexerAny.has("kw_on") ? { type: "kw_on" } : kw_on,
				"lparen",
				"expr_list_raw",
				"rparen",
			],
		...
		},
		{
			...
			symbols: ["select_distinct$ebnf$1$subexpression$1"],
			postprocess: id,
		},
		...
		},
		{
			name: "select_where",
			symbols: [
				lexerAny.has("kw_where") ? { type: "kw_where" } : kw_where,
				"expr",
			],
			postprocess: last,
		},
		{
			name: "select_groupby",
			symbols: [
				lexerAny.has("kw_group") ? { type: "kw_group" } : kw_group,
				"kw_by",
				"expr_list_raw",
			],
			postprocess: last,
		},
		{
			...
			symbols: ["select_offset"],
		},
		{
			name: "select_limit_offset$ebnf$1$subexpression$1",
			symbols: ["select_limit"],
		},
		{
			name: "select_limit_offset$ebnf$1",
			symbols: ["select_limit_offset$ebnf$1$subexpression$1"],
		},
		{
		...
		},
		{
			...
			symbols: ["select_limit_offset$ebnf$1"],
			postprocess: (x, rej) => {
		...
		{ name: "select_offset$ebnf$1$subexpression$1", symbols: ["kw_rows"] },
		{
			...
			symbols: ["select_offset$ebnf$1$subexpression$1"],
			postprocess: id,
		},
		{ name: "select_offset$ebnf$1", symbols: [], postprocess: () => null },
		{
			name: "select_offset",
			symbols: [
				lexerAny.has("kw_offset") ? { type: "kw_offset" } : kw_offset,
				"expr_nostar",
				"select_offset$ebnf$1",
			],
			postprocess: (x) => track(x, { offset: unwrap(x[1]) }),
		},
		{ name: "select_limit$subexpression$1", symbols: ["select_limit_1"] },
		{ name: "select_limit$subexpression$1", symbols: ["select_limit_2"] },
		{
			name: "select_limit",
			symbols: ["select_limit$subexpression$1"],
			postprocess: (x) => track(x, { limit: unwrap(x) }),
		},
		{
			name: "select_limit_1",
			symbols: [
				lexerAny.has("kw_limit") ? { type: "kw_limit" } : kw_limit,
				"expr_nostar",
			],
			postprocess: last,
		},
		...
		{ name: "select_limit_2$ebnf$1$subexpression$1", symbols: ["kw_next"] },
		{
			...
			symbols: ["select_limit_2$ebnf$1$subexpression$1"],
			postprocess: id,
		},
		...
		{ name: "select_limit_2$subexpression$1", symbols: ["kw_rows"] },
		{
			name: "select_limit_2",
			symbols: [
				lexerAny.has("kw_fetch") ? { type: "kw_fetch" } : kw_fetch,
				"select_limit_2$ebnf$1",
				"expr_nostar",
				"select_limit_2$subexpression$1",
				lexerAny.has("kw_only") ? { type: "kw_only" } : kw_only,
			],
			postprocess: get(2),
		},
		{
			...
			symbols: ["kw_update"],
			postprocess: (x) => track(x, { type: "update" }),
		},
		{
			name: "select_for$subexpression$1",
			symbols: ["kw_no", "kw_key", "kw_update"],
			postprocess: (x) => track(x, { type: "no key update" }),
		},
		{
			name: "select_for$subexpression$1",
			symbols: ["kw_share"],
			postprocess: (x) => track(x, { type: "share" }),
		},
		{
			name: "select_for$subexpression$1",
			symbols: ["kw_key", "kw_share"],
			postprocess: (x) => track(x, { type: "key share" }),
		},
		{
			name: "select_for",
			symbols: [
				lexerAny.has("kw_for") ? { type: "kw_for" } : kw_for,
		...
		},
		{
			...
			symbols: [
				lexerAny.has("kw_order") ? { type: "kw_order" } : kw_order,
				"kw_by",
			],
		},
		{ name: "select_order_by$ebnf$1", symbols: [] },
		{
			...
			symbols: ["comma", "select_order_by_expr"],
			postprocess: last,
		},
		{
		...
		},
		{
			...
			symbols: ["select_order_by_expr$ebnf$1$subexpression$1"],
			postprocess: id,
		},
		{
			name: "select_order_by_expr$ebnf$1",
		...
		},
		{
			...
			symbols: ["select_order_by_expr$ebnf$2$subexpression$1"],
			postprocess: id,
		},
		{
			name: "select_order_by_expr$ebnf$2",
		...
		{
			name: "expr_paren",
			symbols: ["lparen", "expr_paren$subexpression$1", "rparen"],
			postprocess: get(1),
		},
		{
		...
		},
		{
			...
			symbols: ["expr_or$macrocall$2$macrocall$2"],
			postprocess: (x) =>
				track(x, {
		...
		},
		{
			...
			symbols: ["expr_or$macrocall$2$macrocall$1"],
		},
		...
		},
		{
			...
			symbols: ["expr_and$macrocall$2$macrocall$2"],
			postprocess: (x) =>
				track(x, {
					op: (toStr(x, " ") || "<error>").toUpperCase(),
				}),
		},
		{
			...
			symbols: ["expr_and$macrocall$2$macrocall$1"],
		},
		...
		},
		{
			...
			symbols: ["expr_not$macrocall$2$macrocall$2"],
			postprocess: (x) =>
				track(x, {
					op: (toStr(x, " ") || "<error>").toUpperCase(),
				}),
		},
		{
			...
			symbols: ["expr_not$macrocall$2$macrocall$1"],
		},
		...
		{ name: "expr_not$macrocall$4", symbols: ["expr_eq"] },
		{
			...
			symbols: ["expr_not$macrocall$3"],
		},
		{ name: "expr_not$macrocall$1$subexpression$1", symbols: ["expr_paren"] },
		{
			name: "expr_not$macrocall$1",
			symbols: ["expr_not$macrocall$2", "expr_not$macrocall$1$subexpression$1"],
			postprocess: (x) =>
				track(x, {
					type: "unary",
					...unwrap(x[0]),
		...
		{
			name: "expr_not$macrocall$1",
			symbols: ["expr_not$macrocall$4"],
			postprocess: unwrap,
		},
		{ name: "expr_not", symbols: ["expr_not$macrocall$1"] },
		{
			name: "expr_eq$macrocall$2$macrocall$2$subexpression$1",
			symbols: [lexerAny.has("op_eq") ? { type: "op_eq" } : op_eq],
		},
		{
			name: "expr_eq$macrocall$2$macrocall$2$subexpression$1",
			symbols: [lexerAny.has("op_neq") ? { type: "op_neq" } : op_neq],
		},
		{
			name: "expr_eq$macrocall$2$macrocall$2",
			symbols: ["expr_eq$macrocall$2$macrocall$2$subexpression$1"],
		},
		{
			name: "expr_eq$macrocall$2$macrocall$1$macrocall$2",
			symbols: ["expr_eq$macrocall$2$macrocall$2"],
		},
		{
			name: "expr_eq$macrocall$2$macrocall$1$macrocall$1",
			symbols: ["expr_eq$macrocall$2$macrocall$1$macrocall$2"],
			postprocess: (x) =>
				track(x, {
					op: (toStr(x, " ") || "<error>").toUpperCase(),
				}),
		},
		{
			...
			symbols: ["expr_eq$macrocall$2$macrocall$1$macrocall$1"],
			postprocess: unwrap,
		},
		{
			name: "expr_eq$macrocall$2$macrocall$1",
		...
		{ name: "expr_eq", symbols: ["expr_eq$macrocall$1"] },
		{
			name: "expr_star",
			symbols: ["star"],
			postprocess: (x) => track(x, { type: "ref", name: "*" }),
		},
		...
		},
		{
			name: "expr_is$subexpression$2",
			symbols: [
				lexerAny.has("kw_is") ? { type: "kw_is" } : kw_is,
				lexerAny.has("kw_null") ? { type: "kw_null" } : kw_null,
			],
		},
		{
			name: "expr_is",
			symbols: ["expr_is$subexpression$1", "expr_is$subexpression$2"],
			postprocess: (x) =>
				track(x, { type: "unary", op: "IS NULL", operand: unwrap(x[0]) }),
		},
		...
		{
			name: "expr_is",
			symbols: ["expr_is$subexpression$3", "expr_is$subexpression$4"],
			postprocess: (x) =>
				track(x, { type: "unary", op: "IS NOT NULL", operand: unwrap(x[0]) }),
		},
		...
		{ name: "expr_is", symbols: ["expr_compare"], postprocess: unwrap },
		{
			...
			symbols: [
				lexerAny.has("op_compare") ? { type: "op_compare" } : op_compare,
			],
		},
		{
			name: "expr_compare$macrocall$2$macrocall$1$macrocall$2",
			symbols: ["expr_compare$macrocall$2$macrocall$2"],
		},
		{
			name: "expr_compare$macrocall$2$macrocall$1$macrocall$1",
			symbols: ["expr_compare$macrocall$2$macrocall$1$macrocall$2"],
			postprocess: (x) =>
				track(x, {
					op: (toStr(x, " ") || "<error>").toUpperCase(),
				}),
		},
		{
			...
			symbols: ["expr_compare$macrocall$2$macrocall$1$macrocall$1"],
			postprocess: unwrap,
		},
		{
			name: "expr_compare$macrocall$2$macrocall$1",
		...
		},
		{
			...
			symbols: ["expr_compare$macrocall$2$macrocall$1"],
		},
		...
		{ name: "expr_compare$macrocall$4", symbols: ["expr_range"] },
		{
			...
			symbols: ["expr_compare$macrocall$3"],
		},
		{
			name: "expr_compare$macrocall$1$subexpression$1",
			symbols: ["expr_paren"],
		},
		{
			...
			symbols: ["expr_compare$macrocall$4"],
		},
		{
			name: "expr_compare$macrocall$1$subexpression$2",
			symbols: ["expr_paren"],
		...
		{ name: "expr_range$macrocall$5", symbols: ["expr_others"] },
		{
			...
			symbols: ["expr_range$macrocall$4"],
		},
		...
		{ name: "expr_range$macrocall$1$subexpression$2", symbols: ["expr_paren"] },
		{
			...
			symbols: ["expr_range$macrocall$5"],
		},
		...
		{ name: "expr_range", symbols: ["expr_range$macrocall$1"] },
		{
			...
			symbols: [
				lexerAny.has("ops_others") ? { type: "ops_others" } : ops_others,
			],
		},
		{
			name: "expr_others$macrocall$2$macrocall$1$macrocall$2",
			symbols: ["expr_others$macrocall$2$macrocall$2"],
		},
		{
			name: "expr_others$macrocall$2$macrocall$1$macrocall$1",
			symbols: ["expr_others$macrocall$2$macrocall$1$macrocall$2"],
			postprocess: (x) =>
				track(x, {
					op: (toStr(x, " ") || "<error>").toUpperCase(),
				}),
		},
		{
			...
			symbols: ["expr_others$macrocall$2$macrocall$1$macrocall$1"],
			postprocess: unwrap,
		},
		{
			name: "expr_others$macrocall$2$macrocall$1",
		...
		},
		{
			...
			symbols: ["expr_others$macrocall$2$macrocall$1"],
		},
		...
		{ name: "expr_others$macrocall$4", symbols: ["expr_like"] },
		{
			...
			symbols: ["expr_others$macrocall$3"],
		},
		{
			name: "expr_others$macrocall$1$subexpression$1",
			symbols: ["expr_paren"],
		},
		{
			...
			symbols: ["expr_others$macrocall$4"],
		},
		{
			name: "expr_others$macrocall$1$subexpression$2",
			symbols: ["expr_paren"],
		...
		{ name: "expr_like$macrocall$2$macrocall$2", symbols: ["ops_like"] },
		{
			...
			symbols: ["expr_like$macrocall$2$macrocall$2"],
			postprocess: (x) =>
				track(x, {
					op: (toStr(x, " ") || "<error>").toUpperCase(),
				}),
		},
		{
			...
			symbols: ["expr_like$macrocall$2$macrocall$1"],
		},
		...
		{ name: "expr_in$macrocall$2$macrocall$2", symbols: ["ops_in"] },
		{
			...
			symbols: ["expr_in$macrocall$2$macrocall$2"],
			postprocess: (x) =>
				track(x, {
					op: (toStr(x, " ") || "<error>").toUpperCase(),
				}),
		},
		{
			...
			symbols: ["expr_in$macrocall$2$macrocall$1"],
		},
		...
		{ name: "expr_in", symbols: ["expr_in$macrocall$1"] },
		{
			...
			symbols: [lexerAny.has("op_plus") ? { type: "op_plus" } : op_plus],
		},
		{
			name: "expr_add$macrocall$2$macrocall$2$subexpression$1",
			symbols: [lexerAny.has("op_minus") ? { type: "op_minus" } : op_minus],
		},
		{
			name: "expr_add$macrocall$2$macrocall$2$subexpression$1",
			symbols: [
				lexerAny.has("op_additive") ? { type: "op_additive" } : op_additive,
			],
		},
		{
			name: "expr_add$macrocall$2$macrocall$2",
			symbols: ["expr_add$macrocall$2$macrocall$2$subexpression$1"],
		},
		{
			name: "expr_add$macrocall$2$macrocall$1$macrocall$2",
			symbols: ["expr_add$macrocall$2$macrocall$2"],
		},
		{
			name: "expr_add$macrocall$2$macrocall$1$macrocall$1",
			symbols: ["expr_add$macrocall$2$macrocall$1$macrocall$2"],
			postprocess: (x) =>
				track(x, {
					op: (toStr(x, " ") || "<error>").toUpperCase(),
				}),
		},
		{
			...
			symbols: ["expr_add$macrocall$2$macrocall$1$macrocall$1"],
			postprocess: unwrap,
		},
		{
			name: "expr_add$macrocall$2$macrocall$1",
		...
		},
		{
			...
			symbols: ["expr_add$macrocall$2$macrocall$1"],
		},
		...
		{
			name: "expr_mult$macrocall$2$macrocall$2$subexpression$1",
			symbols: [lexerAny.has("op_div") ? { type: "op_div" } : op_div],
		},
		{
			name: "expr_mult$macrocall$2$macrocall$2$subexpression$1",
			symbols: [lexerAny.has("op_mod") ? { type: "op_mod" } : op_mod],
		},
		{
			name: "expr_mult$macrocall$2$macrocall$2",
			symbols: ["expr_mult$macrocall$2$macrocall$2$subexpression$1"],
		},
		{
			name: "expr_mult$macrocall$2$macrocall$1$macrocall$2",
			symbols: ["expr_mult$macrocall$2$macrocall$2"],
		},
		{
			name: "expr_mult$macrocall$2$macrocall$1$macrocall$1",
			symbols: ["expr_mult$macrocall$2$macrocall$1$macrocall$2"],
			postprocess: (x) =>
				track(x, {
					op: (toStr(x, " ") || "<error>").toUpperCase(),
				}),
		},
		{
			...
			symbols: ["expr_mult$macrocall$2$macrocall$1$macrocall$1"],
			postprocess: unwrap,
		},
		{
			name: "expr_mult$macrocall$2$macrocall$1",
		...
		},
		{
			...
			symbols: ["expr_mult$macrocall$2$macrocall$1"],
		},
		...
		{ name: "expr_mult", symbols: ["expr_mult$macrocall$1"] },
		{
			...
			symbols: [lexerAny.has("op_exp") ? { type: "op_exp" } : op_exp],
		},
		{
			name: "expr_exp$macrocall$2$macrocall$1$macrocall$2",
			symbols: ["expr_exp$macrocall$2$macrocall$2"],
		},
		{
			name: "expr_exp$macrocall$2$macrocall$1$macrocall$1",
			symbols: ["expr_exp$macrocall$2$macrocall$1$macrocall$2"],
			postprocess: (x) =>
				track(x, {
					op: (toStr(x, " ") || "<error>").toUpperCase(),
				}),
		},
		{
			...
			symbols: ["expr_exp$macrocall$2$macrocall$1$macrocall$1"],
			postprocess: unwrap,
		},
		{
			name: "expr_exp$macrocall$2$macrocall$1",
		...
		},
		{
			...
			symbols: ["expr_exp$macrocall$2$macrocall$1"],
		},
		...
		},
		{
			...
			symbols: ["expr_unary_add$macrocall$2$macrocall$2$subexpression$1"],
		},
		{
			name: "expr_unary_add$macrocall$2$macrocall$1$macrocall$2",
			symbols: ["expr_unary_add$macrocall$2$macrocall$2"],
		},
		{
			name: "expr_unary_add$macrocall$2$macrocall$1$macrocall$1",
			symbols: ["expr_unary_add$macrocall$2$macrocall$1$macrocall$2"],
			postprocess: (x) =>
				track(x, {
					op: (toStr(x, " ") || "<error>").toUpperCase(),
				}),
		},
		{
			...
			symbols: ["expr_unary_add$macrocall$2$macrocall$1$macrocall$1"],
			postprocess: unwrap,
		},
		{
			name: "expr_unary_add$macrocall$2$macrocall$1",
		...
		},
		{
			...
			symbols: ["expr_various_constructs$macrocall$2$macrocall$1"],
		},
		{
		...
		},
		{
			...
			symbols: ["expr_array_index"],
		},
		{
			name: "expr_various_constructs$macrocall$1$subexpression$1",
			symbols: ["expr_various_constructs$macrocall$3"],
		},
		{
			name: "expr_various_constructs$macrocall$1$subexpression$1",
			symbols: ["expr_paren"],
		},
		{
			...
			symbols: ["expr_various_constructs$macrocall$4"],
		},
		{
			name: "expr_various_constructs$macrocall$1$subexpression$2",
			symbols: ["expr_paren"],
		...
		},
		{
			...
			symbols: ["expr_various_constructs$macrocall$1"],
		},
		...
		{ name: "expr_member$subexpression$3", symbols: ["expr_paren"] },
		{
			...
			symbols: [
				...
				lexerAny.has("op_cast") ? { type: "op_cast" } : op_cast,
				"data_type",
			],
			postprocess: (x) =>
				track(x, {
		...
		},
		{
			name: "expr_member",
			symbols: [
				lexerAny.has("kw_cast") ? { type: "kw_cast" } : kw_cast,
				"lparen",
				"expr_nostar",
				lexerAny.has("kw_as") ? { type: "kw_as" } : kw_as,
				"data_type",
				"rparen",
			],
			postprocess: (x) =>
		...
		{ name: "expr_array$ebnf$1", symbols: [], postprocess: () => null },
		{
			name: "expr_array",
			symbols: [
				lexerAny.has("kw_array") ? { type: "kw_array" } : kw_array,
				lexerAny.has("lbracket") ? { type: "lbracket" } : lbracket,
				"expr_array$ebnf$1",
				lexerAny.has("rbracket") ? { type: "rbracket" } : rbracket,
			],
		...
		},
		{
			...
			symbols: ["expr_subarray_items$macrocall$1"],
		...
		{
			name: "expr_subarray_items",
			symbols: ["expr_subarray_items$macrocall$3"],
			postprocess: (x: any) => {
		...
		{
			name: "expr_function_args$macrocall$2",
			symbols: ["expr_function_arg_item"],
		},
		{ name: "expr_function_args$macrocall$1$ebnf$1", symbols: [] },
		{
			name: "expr_function_args$macrocall$1$ebnf$1$subexpression$1",
			symbols: [
				lexerAny.has("comma") ? { type: "comma" } : comma,
				"expr_function_args$macrocall$2",
			],
			postprocess: last,
		},
		{
			name: "expr_function_args$macrocall$1$ebnf$1",
			symbols: [
				"expr_function_args$macrocall$1$ebnf$1",
				"expr_function_args$macrocall$1$ebnf$1$subexpression$1",
			],
			postprocess: (d) => d[0].concat([d[1]]),
		},
		{
			name: "expr_function_args$macrocall$1",
			symbols: [
				"expr_function_args$macrocall$2",
				"expr_function_args$macrocall$1$ebnf$1",
			],
		...
		{
			name: "expr_function_args",
			symbols: ["expr_function_args$macrocall$1"],
			postprocess: ([x]) => x.map(unwrap),
		},
		{
			name: "expr_function_arg_item",
			symbols: ["word", { literal: "=>" }, "expr_function_arg_value"],
			postprocess: (x) => unwrap({ key: x[0], ...x[2] }),
		},
		{
			name: "expr_function_arg_item",
			symbols: ["expr_function_arg_value"],
			postprocess: (x) => unwrap(x),
		},
		{
			name: "expr_function_arg_value",
			symbols: ["data_type", "string"],
			postprocess: (x) =>
				track(x, {
					type: "cast",
		...
		},
		{
			...
			symbols: ["expr_call$ebnf$1$subexpression$1"],
			postprocess: id,
		},
		...
		},
		{
			...
			symbols: ["expr_call$ebnf$4$subexpression$1"],
			postprocess: id,
		},
		...
		},
		{
			...
			symbols: ["kw_partition", "kw_by", "expr_list_raw"],
			postprocess: last,
		},
		{
			name: "expr_call_over$ebnf$1",
			symbols: ["expr_call_over$ebnf$1$subexpression$1"],
			postprocess: id,
		},
		...
		},
		{
			name: "expr_primary",
			symbols: ["float"],
			postprocess: (x) => track(x, { type: "numeric", value: unbox(x[0]) }),
		},
		{
			name: "expr_primary",
			symbols: ["int"],
			postprocess: (x) => track(x, { type: "integer", value: unbox(x[0]) }),
		},
		{
			name: "expr_primary",
			symbols: ["string"],
			postprocess: (x) => track(x, { type: "string", value: unbox(x[0]) }),
		},
		{
			name: "expr_primary",
			symbols: [lexerAny.has("kw_true") ? { type: "kw_true" } : kw_true],
			postprocess: (x) => track(x, { type: "boolean", value: true }),
		},
		{
			name: "expr_primary",
			symbols: [lexerAny.has("kw_false") ? { type: "kw_false" } : kw_false],
			postprocess: (x) => track(x, { type: "boolean", value: false }),
		},
		{
			name: "expr_primary",
			symbols: [lexerAny.has("kw_null") ? { type: "kw_null" } : kw_null],
			postprocess: (x) => track(x, { type: "null" }),
		},
		{
			name: "expr_primary",
			symbols: ["value_keyword"],
			postprocess: (x) => track(x, { type: "keyword", keyword: toStr(x) }),
		},
		{
			name: "expr_primary",
			symbols: [lexerAny.has("qparam") ? { type: "qparam" } : qparam],
			postprocess: (x) => track(x, { type: "parameter", name: toStr(x[0]) }),
		},
		{
			name: "expr_primary",
			symbols: [
			...
			postprocess: (x) => track(x, { type: "default" }),
		},
		...
		},
		{
			...
			symbols: ["ops_like_keywors$ebnf$1", "ops_like_keywors$subexpression$1"],
		},
		{
			name: "ops_like_operators$subexpression$1",
			symbols: [lexerAny.has("op_like") ? { type: "op_like" } : op_like],
			postprocess: () => "LIKE",
		},
		{
			name: "ops_like_operators",
			symbols: ["ops_like_operators$subexpression$1"],
		},
		{
			name: "ops_like_operators$subexpression$2",
			symbols: [lexerAny.has("op_ilike") ? { type: "op_ilike" } : op_ilike],
			postprocess: () => "ILIKE",
		},
		{
			name: "ops_like_operators",
			symbols: ["ops_like_operators$subexpression$2"],
		},
		{
			name: "ops_like_operators$subexpression$3",
			symbols: [
				lexerAny.has("op_not_like") ? { type: "op_not_like" } : op_not_like,
			],
			postprocess: () => "NOT LIKE",
		},
		{
			name: "ops_like_operators",
			symbols: ["ops_like_operators$subexpression$3"],
		},
		{
			name: "ops_like_operators$subexpression$4",
			symbols: [
				lexerAny.has("op_not_ilike") ? { type: "op_not_ilike" } : op_not_ilike,
			],
			postprocess: () => "NOT ILIKE",
		},
		{
			name: "ops_like_operators",
			symbols: ["ops_like_operators$subexpression$4"],
		},
		{
			name: "ops_in$ebnf$1",
			symbols: [lexerAny.has("kw_not") ? { type: "kw_not" } : kw_not],
		...
		{ name: "ops_in$ebnf$1", symbols: [], postprocess: () => null },
		{
			...
			symbols: [
				"ops_in$ebnf$1",
				lexerAny.has("kw_in") ? { type: "kw_in" } : kw_in,
			],
		},
		{
		...
		{ name: "ops_between", symbols: ["ops_between$ebnf$1", "kw_between"] },
		{
			...
			symbols: [lexerAny.has("op_member") ? { type: "op_member" } : op_member],
		},
		{
			name: "ops_member$subexpression$1",
			symbols: [
		...
		{
			name: "ops_member",
			symbols: ["ops_member$subexpression$1"],
			postprocess: (x) => unwrap(x)?.value,
		},
		{
			name: "expr_list_item",
			symbols: ["expr_or_select"],
			postprocess: unwrap,
		},
		...
		{
			name: "expr_list_raw",
			symbols: ["expr_list_raw$macrocall$1"],
			postprocess: ([x]) => x.map(unwrap),
		},
		...
		},
		{
			...
			symbols: ["expr_list_raw_many$macrocall$1$ebnf$1$subexpression$1"],
		},
		{
		...
		},
		{
			...
			symbols: ["expr_list_raw_many$macrocall$1"],
			postprocess: ([x]) => x.map(unwrap),
		},
		...
		{ name: "expr_case$ebnf$2", symbols: [] },
		{
			...
			symbols: ["expr_case$ebnf$2", "expr_case_whens"],
			postprocess: (d) => d[0].concat([d[1]]),
		},
		...
		{ name: "expr_case$ebnf$3", symbols: [], postprocess: () => null },
		{
			name: "expr_case",
			symbols: [
				lexerAny.has("kw_case") ? { type: "kw_case" } : kw_case,
				"expr_case$ebnf$1",
				"expr_case$ebnf$2",
				"expr_case$ebnf$3",
				lexerAny.has("kw_end") ? { type: "kw_end" } : kw_end,
			],
			postprocess: (x) =>
				track(x, {
					type: "case",
		...
		},
		{
			...
			symbols: [
				lexerAny.has("kw_when") ? { type: "kw_when" } : kw_when,
				"expr_nostar",
				lexerAny.has("kw_then") ? { type: "kw_then" } : kw_then,
				"expr_nostar",
			],
			postprocess: (x) =>
				track(x, {
		...
		},
		{
			name: "expr_case_else",
			symbols: [
				lexerAny.has("kw_else") ? { type: "kw_else" } : kw_else,
				"expr_nostar",
			],
			postprocess: last,
		},
		{
			...
			symbols: ["word", lexerAny.has("dot") ? { type: "dot" } : dot],
		},
		{
			name: "expr_fn_name$subexpression$1$ebnf$1",
			symbols: ["expr_fn_name$subexpression$1$ebnf$1$subexpression$1"],
			postprocess: id,
		},
		{
			name: "expr_fn_name$subexpression$1$ebnf$1",
		...
		},
		{
			...
			symbols: ["expr_fn_name$subexpression$1$ebnf$1", "word_or_keyword"],
			postprocess: (x) => {
				return track(x, {
		...
		},
		{
			...
			symbols: ["expr_fn_name$subexpression$2$subexpression$1"],
			postprocess: (x) =>
				track(x, {
					name: toStr(unwrap(x)),
				}),
		...
		},
		{
			...
			symbols: [
				lexerAny.has("lparen") ? { type: "lparen" } : lparen,
				"expr_nostar",
			],
		},
		{
		...
		},
		{
			...
			symbols: ["spe_overlay$ebnf$1$subexpression$1"],
			postprocess: id,
		},
		{ name: "spe_overlay$ebnf$1", symbols: [], postprocess: () => null },
		{
			...
			symbols: [
				...
				"spe_overlay$ebnf$1",
				lexerAny.has("rparen") ? { type: "rparen" } : rparen,
			],
			postprocess: (x) =>
				track(x, {
					type: "overlay",
		...
		},
		{
			...
			symbols: ["spe_substring$ebnf$1$subexpression$1"],
			postprocess: id,
		},
		...
		},
		{
			...
			symbols: ["spe_substring$ebnf$2$subexpression$1"],
			postprocess: id,
		},
		...
		},
		{
			...
			symbols: ["comment_what_nm$subexpression$1", "qualified_name"],
			postprocess: (x) =>
				track(x, {
					type: toStr(x[0]),
					name: x[1],
		...
		},
		{
			...
			symbols: [
				"kw_insert",
				lexerAny.has("kw_into") ? { type: "kw_into" } : kw_into,
			],
		},
		{
			name: "insert_statement$ebnf$1",
			symbols: ["collist_paren"],
			postprocess: id,
		},
		...
		},
		{
			...
			symbols: ["insert_statement$ebnf$2$subexpression$1"],
			postprocess: id,
		},
		...
		{
			name: "insert_statement$ebnf$3$subexpression$1",
			symbols: ["selection_paren"],
		},
		{
			name: "insert_statement$ebnf$3",
			symbols: ["insert_statement$ebnf$3$subexpression$1"],
			postprocess: id,
		},
		...
		},
		{
			...
			symbols: ["insert_statement$ebnf$4$subexpression$1"],
			postprocess: id,
		},
		...
		},
		{
			...
			symbols: ["update_statement$ebnf$1$subexpression$1"],
			postprocess: id,
		},
		...
		},
		{
			...
			symbols: ["update_statement$ebnf$3$subexpression$1"],
			postprocess: id,
		},
		...
		},
		{
			...
			symbols: ["update_set", "update_set_list$ebnf$1"],
			postprocess: ([head, tail]) => {
				const ret = [];
		...
		{ name: "update_set", symbols: ["update_set_multiple"] },
		{
			...
			symbols: [
				"ident",
				lexerAny.has("op_eq") ? { type: "op_eq" } : op_eq,
				"expr",
			],
			postprocess: (x) =>
				box(x, {
		...
		},
		{
			...
			symbols: ["lparen", "expr_list_raw", "rparen"],
			postprocess: get(1),
		},
		{
		...
		},
		{
			...
			symbols: ["delete_delete$ebnf$2$subexpression$1"],
			postprocess: id,
		},
		...
		{
			name: "main$ebnf$1",
			symbols: ["main$ebnf$1", "statement_separator"],
			postprocess: (d) => d[0].concat([d[1]]),
		},
		{ name: "main$ebnf$2", symbols: [] },
		{
			name: "main$ebnf$2$subexpression$1$ebnf$1",
			symbols: ["statement_separator"],
		},
		{
			name: "main$ebnf$2$subexpression$1$ebnf$1",
			symbols: ["main$ebnf$2$subexpression$1$ebnf$1", "statement_separator"],
			postprocess: (d) => d[0].concat([d[1]]),
		},
		{
			name: "main$ebnf$2$subexpression$1",
			symbols: ["main$ebnf$2$subexpression$1$ebnf$1", "statement"],
		},
		{
			name: "main$ebnf$2",
		...
		{
			name: "main$ebnf$3",
			symbols: ["main$ebnf$3", "statement_separator"],
			postprocess: (d) => d[0].concat([d[1]]),
		},
		{
			name: "main",
			symbols: ["main$ebnf$1", "statement", "main$ebnf$2", "main$ebnf$3"],
		...
		},
		{
			...
			symbols: [lexerAny.has("semicolon") ? { type: "semicolon" } : semicolon],
		},
