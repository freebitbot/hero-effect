...
import { astMapper, type IAstMapper } from "./astMapper";
import type { ReplaceReturnType } from "./utils";

export type IAstPartialVisitor = {
	[key in keyof IAstPartialMapper]: ReplaceReturnType<
...
for (const k of Object.getOwnPropertyNames(mapperProto)) {
	...
	Object.defineProperty(Visitor.prototype, k, {
		configurable: false,
		get() {
			return function get(this: Visitor, ...args: any[]) {
 ...
 * ```
 */
export function astVisitor<T extends IAstPartialVisitor = IAstPartialVisitor>(
