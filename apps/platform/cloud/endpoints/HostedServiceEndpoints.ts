...
export type TConnectionToServicesClient = IConnectionToClient<
	TServicesApis,
	{}
>;
	...
	constructor() {
		...
		for (const [api, handler] of Object.entries(this.handlersByCommand)) {
			const validationSchema =
				NodeRegistryApiSchemas[api] ?? ServicesSetupApiSchemas[api];
