...
import type { IValidationError } from "../interfaces/IValidationResult";
...
> {
	...
	static inspect(
		schema: any,
		needsParens = false,
		circular = new Set<BaseSchema<any>>(),
	): string {
...
function ValidationTracker(): IValidationTracker {
	const members: WeakMap<
		object,
		WeakMap<BaseSchema<any>, true>
	> = new WeakMap();
