import ArraySchema, { type IArraySchemaConfig } from "./lib/ArraySchema";
import BaseSchema, { type IBaseConfig } from "./lib/BaseSchema";
import BigintSchema, { type IBigintSchemaConfig } from "./lib/BigintSchema";
import BooleanSchema, { type IBooleanSchemaConfig } from "./lib/BooleanSchema";
import BufferSchema, { type IBufferSchemaConfig } from "./lib/BufferSchema";
import DateSchema, { type IDateSchemaConfig } from "./lib/DateSchema";
import { DateUtilities, type IUnits } from "./lib/DateUtilities";
import NumberSchema, { type INumberSchemaConfig } from "./lib/NumberSchema";
import ObjectSchema, { type IObjectSchemaConfig } from "./lib/ObjectSchema";
import RecordSchema, { type IRecordSchemaConfig } from "./lib/RecordSchema";
import StringSchema, { type IStringSchemaConfig } from "./lib/StringSchema";
...
export { ArraySchema, DateUtilities, type ISchemaAny, ObjectSchema };
...
export type ExtractSchemaType<T> =
	T extends BaseSchema<infer U, boolean>
		? U
		: T extends Record<string, BaseSchema<any, boolean>>
			? IRecordSchemaType<T>
			: unknown;
...
export function record<
	Values extends BaseSchema<any, boolean>,
...
export function object<
	...
	S extends BaseSchema<any, boolean> & IBaseConfig<TOptional> = BaseSchema<
		any,
		boolean
	> &
		IBaseConfig<TOptional>,
...
export function object(fieldsOrConfig): ObjectSchema<any> {
	if (
		...
		fieldsOrConfig = { fields: fieldsOrConfig } as IObjectSchemaConfig<
			any,
			any
		>;
	}
...
export function array<
	...
	TOptional extends boolean = false,
>(config: IArraySchemaConfig<E, TOptional>): ArraySchema<E, TOptional>;
export function array<
	E extends BaseSchema<any>,
	TOptional extends boolean = false,
>(
