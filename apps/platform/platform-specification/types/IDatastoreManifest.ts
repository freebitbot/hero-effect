...
export const DatastoreManifestSchema = z.object({
	...
	schemaInterface: z
		.string()
		.optional()
		.describe("The raw typescript schema for this Datastore"),
	...
	domain: z
		...
		.optional()
		.describe(
			"An Argon domain for this manifest. It can be looked up in the mainchain as a dns lookup for the version hosting.\n" +
...
type IDatastorePaymentRecipient = z.infer<
	typeof DatastorePaymentRecipientSchema
>;

export type { IDatastorePaymentRecipient };
