...
export const DatastoreStatsSchema = z.object({
	...
	maxMilliseconds: positiveInt.describe(
		"Max milliseconds spent before response.",
	),
	averageTotalPricePerQuery: positiveBigInt.describe(
		"Average total microgons paid for a query.",
	),
	maxPricePerQuery: positiveBigInt.describe(
		"The largest total microgon price seen.",
	),
});
