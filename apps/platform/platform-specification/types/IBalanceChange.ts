...
export const AccountOriginSchema = z.object({
	notebookNumber: notebookNumberValidation.describe(
		"The notebook where this account originated",
	),
	accountUid: z
		.number()
		.int()
		.describe("The unique user index in the given notebook"),
});
...
export const BalanceProofSchema = z.object({
	notaryId: notaryIdValidation.describe(
		"The notary where this proof was provided",
	),
