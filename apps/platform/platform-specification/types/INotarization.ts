...
export const DomainSchema = z.tuple([
	...
	addressValidation.describe(
		"The account id the data domain is registered to.",
	),
]);

export const BlockVoteSchema = z.object({
	accountId: addressValidation,
	blockHash: hashValidation.describe(
	...
	index: z
		...
		.int()
		.nonnegative()
		.describe("An index to provide noise to the vote hash"),
	power: microgonsValidation.describe(
		"The tax applied (and thus multiplier) of this vote",
	),
	signature: multiSignatureValidation.describe(
		"The signature of the vote hash",
	),
