	...
	"NodeRegistry.health": {
		args: z.object({
			...
			coreMetrics: z.object({
				...
				heroSessions: z
					.number()
					.describe("Hero sessions created since last run-time."),
			...
			clientConnections: z
				.number()
				.describe("Clients currently connected to the public api."),
		}),
		result: z.object({
			success: z.boolean(),
		}),
...
export type INodeRegistryApiTypes = IZodSchemaToApiTypes<
