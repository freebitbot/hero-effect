...
export const DatastoreManifestWithLatest = DatastoreManifestSchema.extend({
	latestVersion: semverValidation.describe(
		"The newest version of this Datastore.",
	),
	isStarted: z
		.boolean()
		.describe("Is the Datastore started. Only relevant in development mode."),
});
...
export type IDatastoreRegistryApiTypes = IZodSchemaToApiTypes<
...
export type IDatastoreRegistryApis<TContext = any> = IZodHandlers<
	...
	TContext
>;
export type IDatastoreManifestWithLatest = z.infer<
	typeof DatastoreManifestWithLatest
>;
